...
% 
% q_NMSE = q_MSE./(max(joint_variables_q_measured.Data) - min(joint_variables_q_measured.Data))
% dq_NMSE = dq_MSE./(max(joint_variables_dq_measured.Data) - min(joint_variables_dq_measured.Data))
% torque_NMSE = torque_MSE./(max(torque_target_measured.Data) - min(torque_target_measured.Data))
