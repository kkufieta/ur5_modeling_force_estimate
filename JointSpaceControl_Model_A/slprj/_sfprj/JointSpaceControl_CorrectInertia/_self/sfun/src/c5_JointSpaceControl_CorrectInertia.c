...
static void initialize_c5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void initialize_params_c5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void enable_c5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void disable_c5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void set_sim_state_c5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, const
   mxArray *c5_st);
static void finalize_c5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void sf_c5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void initSimStructsc5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void registerMessagesc5_JointSpaceControl_CorrectInertia
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
...
static real_T c5_mpower(SFc5_JointSpaceControl_CorrectInertiaInstanceStruct
  *chartInstance, real_T c5_a);
static void c5_eml_scalar_eg(SFc5_JointSpaceControl_CorrectInertiaInstanceStruct
  *chartInstance);
static void c5_eml_error(SFc5_JointSpaceControl_CorrectInertiaInstanceStruct
  *chartInstance);
static real_T c5_atan2(SFc5_JointSpaceControl_CorrectInertiaInstanceStruct
...
static uint8_T c5_d_emlrt_marshallIn
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, const
   mxArray *c5_b_is_active_c5_JointSpaceControl_CorrectInertia, const char_T
   *c5_identifier);
  ...
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_JointSpaceControl_CorrectInertia = 0U;
}
  ...
  (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance)
{
  ...
  c5_d_hoistedGlobal =
    chartInstance->c5_is_active_c5_JointSpaceControl_CorrectInertia;
   ...
   mxArray *c5_st)
{
  ...
  *c5_theta = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
  ...
  chartInstance->c5_is_active_c5_JointSpaceControl_CorrectInertia =
    ...
    "is_active_c5_JointSpaceControl_CorrectInertia");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_JointSpaceControl_CorrectInertia(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c5_JointSpaceControl_CorrectInertia_get_eml_resolved_functions_info(void)
{
   ...
   *c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_JointSpaceControl_CorrectInertia), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_JointSpaceControl_CorrectInertia);
  return c5_y;
}
...
void sf_c5_JointSpaceControl_CorrectInertia_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_JointSpaceControl_CorrectInertia_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_JointSpaceControl_CorrectInertia_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c5_JointSpaceControl_CorrectInertia
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[6],T\"phi\",},{M[1],M[10],T\"psi\",},{M[1],M[9],T\"theta\",},{M[8],M[0],T\"is_active_c5_JointSpaceControl_CorrectInertia\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_JointSpaceControl_CorrectInertia_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c5_JointSpaceControl_CorrectInertia
    ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
  initialize_c5_JointSpaceControl_CorrectInertia
    ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  enable_c5_JointSpaceControl_CorrectInertia
    ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  disable_c5_JointSpaceControl_CorrectInertia
    ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  sf_c5_JointSpaceControl_CorrectInertia
    ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_JointSpaceControl_CorrectInertia(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_JointSpaceControl_CorrectInertia
    ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_JointSpaceControl_CorrectInertia
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c5_JointSpaceControl_CorrectInertia
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_JointSpaceControl_CorrectInertia
    ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_JointSpaceControl_CorrectInertia(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_JointSpaceControl_CorrectInertia(S);
}

static void sf_opaque_set_sim_state_c5_JointSpaceControl_CorrectInertia
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_JointSpaceControl_CorrectInertia(S, st);
}

static void sf_opaque_terminate_c5_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_JointSpaceControl_CorrectInertia
      ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_JointSpaceControl_CorrectInertia
    ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_JointSpaceControl_CorrectInertia(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_JointSpaceControl_CorrectInertia
      ((SFc5_JointSpaceControl_CorrectInertiaInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_JointSpaceControl_CorrectInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c5_JointSpaceControl_CorrectInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_JointSpaceControl_CorrectInertia(SimStruct *S)
{
  SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc5_JointSpaceControl_CorrectInertiaInstanceStruct *)
    utMalloc(sizeof(SFc5_JointSpaceControl_CorrectInertiaInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_JointSpaceControl_CorrectInertia;
...
void c5_JointSpaceControl_CorrectInertia_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_JointSpaceControl_CorrectInertia(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_JointSpaceControl_CorrectInertia(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_JointSpaceControl_CorrectInertia(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_JointSpaceControl_CorrectInertia_method_dispatcher.\n"
