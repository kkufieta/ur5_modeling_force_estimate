...
static void initialize_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initialize_params_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void enable_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void disable_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c20_update_debugger_state_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void set_sim_state_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c20_st);
static void finalize_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void sf_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c20_chartstep_c20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initSimStructsc20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void registerMessagesc20_JointSpaceControl_own_MCP
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
...
static const mxArray *c20_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_emlrt_marshallIn(SFc20_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c20_dX, const char_T *c20_identifier, real_T
  c20_y[6]);
static void c20_b_emlrt_marshallIn(SFc20_JointSpaceControl_own_MCPInstanceStruct
...
static void c20_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData);
static void c20_eml_scalar_eg(SFc20_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
...
static uint8_T c20_e_emlrt_marshallIn
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c20_b_is_active_c20_JointSpaceControl_own_MCP, const char_T *c20_identifier);
static uint8_T c20_f_emlrt_marshallIn
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void init_dsm_address_info(SFc20_JointSpaceControl_own_MCPInstanceStruct *
  chartInstance);
  ...
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c20_is_active_c20_JointSpaceControl_own_MCP = 0U;
}
  ...
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  c20_hoistedGlobal = chartInstance->c20_is_active_c20_JointSpaceControl_own_MCP;
   ...
   *c20_st)
{
  ...
  chartInstance->c20_is_active_c20_JointSpaceControl_own_MCP =
    c20_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 1)),
    "is_active_c20_JointSpaceControl_own_MCP");
  sf_mex_destroy(&c20_u);
  c20_update_debugger_state_c20_JointSpaceControl_own_MCP(chartInstance);
  ...
  (SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c20_sfEvent = CALL_EVENT;
  c20_chartstep_c20_JointSpaceControl_own_MCP(chartInstance);
  ...
  *c20_inData)
{
  ...
  const mxArray *c20_y = NULL;
  SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc20_JointSpaceControl_own_MCPInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c20_JointSpaceControl_own_MCP_get_eml_resolved_functions_info
  (void)
{
   ...
   *c20_b_is_active_c20_JointSpaceControl_own_MCP, const char_T *c20_identifier)
{
  ...
  c20_y = c20_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c20_b_is_active_c20_JointSpaceControl_own_MCP), &c20_thisId);
  sf_mex_destroy(&c20_b_is_active_c20_JointSpaceControl_own_MCP);
  return c20_y;
}
...
void sf_c20_JointSpaceControl_own_MCP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c20_JointSpaceControl_own_MCP_get_autoinheritance_info(void)
{
...
mxArray *sf_c20_JointSpaceControl_own_MCP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c20_JointSpaceControl_own_MCP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[12],T\"dX\",},{M[8],M[0],T\"is_active_c20_JointSpaceControl_own_MCP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_JointSpaceControl_own_MCP_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c20_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc20_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c20_JointSpaceControl_own_MCP
    ((SFc20_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
  initialize_c20_JointSpaceControl_own_MCP
    ((SFc20_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c20_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  enable_c20_JointSpaceControl_own_MCP
    ((SFc20_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c20_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  disable_c20_JointSpaceControl_own_MCP
    ((SFc20_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c20_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  sf_c20_JointSpaceControl_own_MCP
    ((SFc20_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c20_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c20_JointSpaceControl_own_MCP
    ((SFc20_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c20_JointSpaceControl_own_MCP();/* state var info */
...
extern void sf_internal_set_sim_state_c20_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c20_JointSpaceControl_own_MCP
    ((SFc20_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c20_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c20_JointSpaceControl_own_MCP(S);
}

static void sf_opaque_set_sim_state_c20_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c20_JointSpaceControl_own_MCP(S, st);
}

static void sf_opaque_terminate_c20_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc20_JointSpaceControl_own_MCPInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c20_JointSpaceControl_own_MCP
      ((SFc20_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc20_JointSpaceControl_own_MCP
    ((SFc20_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_JointSpaceControl_own_MCP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c20_JointSpaceControl_own_MCP
      ((SFc20_JointSpaceControl_own_MCPInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c20_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c20_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_JointSpaceControl_own_MCP(SimStruct *S)
{
  SFc20_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc20_JointSpaceControl_own_MCPInstanceStruct *)utMalloc
    (sizeof(SFc20_JointSpaceControl_own_MCPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc20_JointSpaceControl_own_MCPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlStart = mdlStart_c20_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c20_JointSpaceControl_own_MCP;
...
void c20_JointSpaceControl_own_MCP_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_JointSpaceControl_own_MCP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_JointSpaceControl_own_MCP_method_dispatcher.\n"
