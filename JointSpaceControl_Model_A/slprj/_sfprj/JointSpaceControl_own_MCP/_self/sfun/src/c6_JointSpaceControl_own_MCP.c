...
static void initialize_c6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initialize_params_c6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void enable_c6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void disable_c6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void set_sim_state_c6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c6_st);
static void finalize_c6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void sf_c6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initSimStructsc6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void registerMessagesc6_JointSpaceControl_own_MCP
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c6_theta, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_c_emlrt_marshallIn(SFc6_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c6_k, const char_T *c6_identifier, real_T c6_y
  [3]);
static void c6_d_emlrt_marshallIn(SFc6_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[3]);
...
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_eml_error(SFc6_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
...
static uint8_T c6_f_emlrt_marshallIn
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c6_b_is_active_c6_JointSpaceControl_own_MCP, const char_T *c6_identifier);
static uint8_T c6_g_emlrt_marshallIn
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
  ...
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_JointSpaceControl_own_MCP = 0U;
}
  ...
  (SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_JointSpaceControl_own_MCP;
   ...
   *c6_st)
{
  ...
  *c6_theta = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u,
    1)), "theta");
  chartInstance->c6_is_active_c6_JointSpaceControl_own_MCP =
    c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 2)),
    "is_active_c6_JointSpaceControl_own_MCP");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_JointSpaceControl_own_MCP(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc6_JointSpaceControl_own_MCPInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c6_JointSpaceControl_own_MCP_get_eml_resolved_functions_info
  (void)
{
   ...
   *c6_b_is_active_c6_JointSpaceControl_own_MCP, const char_T *c6_identifier)
{
  ...
  c6_y = c6_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_JointSpaceControl_own_MCP), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_JointSpaceControl_own_MCP);
  return c6_y;
}
...
void sf_c6_JointSpaceControl_own_MCP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_JointSpaceControl_own_MCP_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_JointSpaceControl_own_MCP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c6_JointSpaceControl_own_MCP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[6],T\"k\",},{M[1],M[9],T\"theta\",},{M[8],M[0],T\"is_active_c6_JointSpaceControl_own_MCP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_JointSpaceControl_own_MCP_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c6_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_JointSpaceControl_own_MCP
    ((SFc6_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
  initialize_c6_JointSpaceControl_own_MCP
    ((SFc6_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_JointSpaceControl_own_MCP(void *chartInstanceVar)
{
  enable_c6_JointSpaceControl_own_MCP
    ((SFc6_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  disable_c6_JointSpaceControl_own_MCP
    ((SFc6_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  sf_c6_JointSpaceControl_own_MCP((SFc6_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_JointSpaceControl_own_MCP
    ((SFc6_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_JointSpaceControl_own_MCP();/* state var info */
...
extern void sf_internal_set_sim_state_c6_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_JointSpaceControl_own_MCP
    ((SFc6_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c6_JointSpaceControl_own_MCP(S);
}

static void sf_opaque_set_sim_state_c6_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c6_JointSpaceControl_own_MCP(S, st);
}

static void sf_opaque_terminate_c6_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_JointSpaceControl_own_MCPInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c6_JointSpaceControl_own_MCP
      ((SFc6_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_JointSpaceControl_own_MCP
    ((SFc6_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_JointSpaceControl_own_MCP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c6_JointSpaceControl_own_MCP
      ((SFc6_JointSpaceControl_own_MCPInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_JointSpaceControl_own_MCP(SimStruct *S)
{
  SFc6_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc6_JointSpaceControl_own_MCPInstanceStruct *)utMalloc
    (sizeof(SFc6_JointSpaceControl_own_MCPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_JointSpaceControl_own_MCPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_JointSpaceControl_own_MCP;
...
void c6_JointSpaceControl_own_MCP_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_JointSpaceControl_own_MCP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_JointSpaceControl_own_MCP_method_dispatcher.\n"
