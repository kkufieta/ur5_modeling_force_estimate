...
static void initialize_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initialize_params_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void enable_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void disable_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void set_sim_state_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c21_st);
static void finalize_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void sf_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c21_chartstep_c21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initSimStructsc21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void registerMessagesc21_JointSpaceControl_own_MCP
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static void c21_emlrt_marshallIn(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c21_dq, const char_T *c21_identifier, real_T
  c21_y[6]);
static void c21_b_emlrt_marshallIn(SFc21_JointSpaceControl_own_MCPInstanceStruct
...
static void c21_invNxN(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c21_x[36], real_T c21_y[36]);
static void c21_realmin(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
static void c21_eps(SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c21_eml_matlab_zgetrf(SFc21_JointSpaceControl_own_MCPInstanceStruct *
  chartInstance, real_T c21_A[36], real_T c21_b_A[36], int32_T c21_ipiv[6],
  int32_T *c21_info);
static void c21_check_forloop_overflow_error
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance, boolean_T
   c21_overflow);
static void c21_eml_xger(SFc21_JointSpaceControl_own_MCPInstanceStruct
...
static void c21_eml_xtrsm(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c21_A[36], real_T c21_B[36], real_T c21_b_B[36]);
static real_T c21_norm(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c21_x[36]);
static void c21_eml_warning(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
static void c21_b_eml_warning(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, char_T c21_varargin_2[14]);
static void c21_eml_scalar_eg(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
static void c21_d_emlrt_marshallIn(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c21_sprintf, const char_T *c21_identifier,
  char_T c21_y[14]);
static void c21_e_emlrt_marshallIn(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId,
  char_T c21_y[14]);
...
static uint8_T c21_g_emlrt_marshallIn
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c21_b_is_active_c21_JointSpaceControl_own_MCP, const char_T *c21_identifier);
static uint8_T c21_h_emlrt_marshallIn
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_b_eml_matlab_zgetrf
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance, real_T c21_A[36],
   int32_T c21_ipiv[6], int32_T *c21_info);
static void c21_b_eml_xger(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, int32_T c21_m, int32_T c21_n, real_T c21_alpha1, int32_T
  c21_ix0, int32_T c21_iy0, real_T c21_A[36], int32_T c21_ia0);
static void c21_b_eml_xtrsm(SFc21_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c21_A[36], real_T c21_B[36]);
static void init_dsm_address_info(SFc21_JointSpaceControl_own_MCPInstanceStruct *
  chartInstance);
  ...
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_JointSpaceControl_own_MCP = 0U;
}
  ...
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  c21_hoistedGlobal = chartInstance->c21_is_active_c21_JointSpaceControl_own_MCP;
   ...
   *c21_st)
{
  ...
  chartInstance->c21_is_active_c21_JointSpaceControl_own_MCP =
    c21_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c21_u, 1)),
    "is_active_c21_JointSpaceControl_own_MCP");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_JointSpaceControl_own_MCP(chartInstance);
  ...
  (SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_sfEvent = CALL_EVENT;
  c21_chartstep_c21_JointSpaceControl_own_MCP(chartInstance);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc21_JointSpaceControl_own_MCPInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c21_JointSpaceControl_own_MCP_get_eml_resolved_functions_info
  (void)
{
   ...
   *c21_b_is_active_c21_JointSpaceControl_own_MCP, const char_T *c21_identifier)
{
  ...
  c21_y = c21_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_JointSpaceControl_own_MCP), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_JointSpaceControl_own_MCP);
  return c21_y;
}
...
void sf_c21_JointSpaceControl_own_MCP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_JointSpaceControl_own_MCP_get_autoinheritance_info(void)
{
...
mxArray *sf_c21_JointSpaceControl_own_MCP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c21_JointSpaceControl_own_MCP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"dq\",},{M[8],M[0],T\"is_active_c21_JointSpaceControl_own_MCP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_JointSpaceControl_own_MCP_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c21_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c21_JointSpaceControl_own_MCP
    ((SFc21_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
  initialize_c21_JointSpaceControl_own_MCP
    ((SFc21_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  enable_c21_JointSpaceControl_own_MCP
    ((SFc21_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  disable_c21_JointSpaceControl_own_MCP
    ((SFc21_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  sf_c21_JointSpaceControl_own_MCP
    ((SFc21_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c21_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_JointSpaceControl_own_MCP
    ((SFc21_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_JointSpaceControl_own_MCP();/* state var info */
...
extern void sf_internal_set_sim_state_c21_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c21_JointSpaceControl_own_MCP
    ((SFc21_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c21_JointSpaceControl_own_MCP(S);
}

static void sf_opaque_set_sim_state_c21_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c21_JointSpaceControl_own_MCP(S, st);
}

static void sf_opaque_terminate_c21_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_JointSpaceControl_own_MCPInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c21_JointSpaceControl_own_MCP
      ((SFc21_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_JointSpaceControl_own_MCP
    ((SFc21_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_JointSpaceControl_own_MCP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c21_JointSpaceControl_own_MCP
      ((SFc21_JointSpaceControl_own_MCPInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c21_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c21_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_JointSpaceControl_own_MCP(SimStruct *S)
{
  SFc21_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc21_JointSpaceControl_own_MCPInstanceStruct *)utMalloc
    (sizeof(SFc21_JointSpaceControl_own_MCPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc21_JointSpaceControl_own_MCPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c21_JointSpaceControl_own_MCP;
...
void c21_JointSpaceControl_own_MCP_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_JointSpaceControl_own_MCP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_JointSpaceControl_own_MCP_method_dispatcher.\n"
