...
static void initialize_c5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initialize_params_c5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void enable_c5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void disable_c5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void set_sim_state_c5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c5_st);
static void finalize_c5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void sf_c5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initSimStructsc5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void registerMessagesc5_JointSpaceControl_own_MCP
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c5_psi, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_JointSpaceControl_own_MCPInstanceStruct
...
static real_T c5_mpower(SFc5_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c5_a);
static void c5_eml_scalar_eg(SFc5_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
static void c5_eml_error(SFc5_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
static real_T c5_atan2(SFc5_JointSpaceControl_own_MCPInstanceStruct
...
static uint8_T c5_d_emlrt_marshallIn
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c5_b_is_active_c5_JointSpaceControl_own_MCP, const char_T *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
  ...
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_JointSpaceControl_own_MCP = 0U;
}
  ...
  (SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  c5_d_hoistedGlobal = chartInstance->c5_is_active_c5_JointSpaceControl_own_MCP;
   ...
   *c5_st)
{
  ...
  *c5_theta = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    2)), "theta");
  chartInstance->c5_is_active_c5_JointSpaceControl_own_MCP =
    c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 3)),
    "is_active_c5_JointSpaceControl_own_MCP");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_JointSpaceControl_own_MCP(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc5_JointSpaceControl_own_MCPInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c5_JointSpaceControl_own_MCP_get_eml_resolved_functions_info
  (void)
{
   ...
   *c5_b_is_active_c5_JointSpaceControl_own_MCP, const char_T *c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_JointSpaceControl_own_MCP), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_JointSpaceControl_own_MCP);
  return c5_y;
}
...
void sf_c5_JointSpaceControl_own_MCP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_JointSpaceControl_own_MCP_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_JointSpaceControl_own_MCP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c5_JointSpaceControl_own_MCP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[6],T\"phi\",},{M[1],M[10],T\"psi\",},{M[1],M[9],T\"theta\",},{M[8],M[0],T\"is_active_c5_JointSpaceControl_own_MCP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_JointSpaceControl_own_MCP_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_JointSpaceControl_own_MCP
    ((SFc5_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
  initialize_c5_JointSpaceControl_own_MCP
    ((SFc5_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_JointSpaceControl_own_MCP(void *chartInstanceVar)
{
  enable_c5_JointSpaceControl_own_MCP
    ((SFc5_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  disable_c5_JointSpaceControl_own_MCP
    ((SFc5_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  sf_c5_JointSpaceControl_own_MCP((SFc5_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_JointSpaceControl_own_MCP
    ((SFc5_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_JointSpaceControl_own_MCP();/* state var info */
...
extern void sf_internal_set_sim_state_c5_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_JointSpaceControl_own_MCP
    ((SFc5_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c5_JointSpaceControl_own_MCP(S);
}

static void sf_opaque_set_sim_state_c5_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c5_JointSpaceControl_own_MCP(S, st);
}

static void sf_opaque_terminate_c5_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_JointSpaceControl_own_MCPInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_JointSpaceControl_own_MCP
      ((SFc5_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_JointSpaceControl_own_MCP
    ((SFc5_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_JointSpaceControl_own_MCP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_JointSpaceControl_own_MCP
      ((SFc5_JointSpaceControl_own_MCPInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_JointSpaceControl_own_MCP(SimStruct *S)
{
  SFc5_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc5_JointSpaceControl_own_MCPInstanceStruct *)utMalloc
    (sizeof(SFc5_JointSpaceControl_own_MCPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_JointSpaceControl_own_MCPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_JointSpaceControl_own_MCP;
...
void c5_JointSpaceControl_own_MCP_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_JointSpaceControl_own_MCP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_JointSpaceControl_own_MCP_method_dispatcher.\n"
