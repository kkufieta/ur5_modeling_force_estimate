...
static void initialize_c8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initialize_params_c8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void enable_c8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void disable_c8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void set_sim_state_c8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c8_st);
static void finalize_c8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void sf_c8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initSimStructsc8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void registerMessagesc8_JointSpaceControl_own_MCP
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c8_R, const char_T *c8_identifier, real_T c8_y
  [9]);
static void c8_b_emlrt_marshallIn(SFc8_JointSpaceControl_own_MCPInstanceStruct
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static void c8_info_helper(c8_ResolvedFunctionInfo c8_info[13]);
static real_T c8_mpower(SFc8_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c8_a);
static void c8_eml_scalar_eg(SFc8_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
...
static uint8_T c8_e_emlrt_marshallIn
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c8_b_is_active_c8_JointSpaceControl_own_MCP, const char_T *c8_identifier);
static uint8_T c8_f_emlrt_marshallIn
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
  ...
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_JointSpaceControl_own_MCP = 0U;
}
  ...
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_JointSpaceControl_own_MCP;
   ...
   *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_JointSpaceControl_own_MCP =
    c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
    "is_active_c8_JointSpaceControl_own_MCP");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_JointSpaceControl_own_MCP(chartInstance);
  ...
  (SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  for (c8_i2 = 0; c8_i2 < 3; c8_i2++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_k)[c8_i2], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c8_b_theta, 1U);
  for (c8_i3 = 0; c8_i3 < 9; c8_i3++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_R)[c8_i3], 2U);
  }
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc8_JointSpaceControl_own_MCPInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c8_JointSpaceControl_own_MCP_get_eml_resolved_functions_info
  (void)
{
   ...
   *c8_b_is_active_c8_JointSpaceControl_own_MCP, const char_T *c8_identifier)
{
  ...
  c8_y = c8_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_JointSpaceControl_own_MCP), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_JointSpaceControl_own_MCP);
  return c8_y;
}
...
void sf_c8_JointSpaceControl_own_MCP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_JointSpaceControl_own_MCP_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_JointSpaceControl_own_MCP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c8_JointSpaceControl_own_MCP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"R\",},{M[8],M[0],T\"is_active_c8_JointSpaceControl_own_MCP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_JointSpaceControl_own_MCP_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_JointSpaceControl_own_MCP
    ((SFc8_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
  initialize_c8_JointSpaceControl_own_MCP
    ((SFc8_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_JointSpaceControl_own_MCP(void *chartInstanceVar)
{
  enable_c8_JointSpaceControl_own_MCP
    ((SFc8_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  disable_c8_JointSpaceControl_own_MCP
    ((SFc8_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  sf_c8_JointSpaceControl_own_MCP((SFc8_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_JointSpaceControl_own_MCP
    ((SFc8_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_JointSpaceControl_own_MCP();/* state var info */
...
extern void sf_internal_set_sim_state_c8_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_JointSpaceControl_own_MCP
    ((SFc8_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c8_JointSpaceControl_own_MCP(S);
}

static void sf_opaque_set_sim_state_c8_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c8_JointSpaceControl_own_MCP(S, st);
}

static void sf_opaque_terminate_c8_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_JointSpaceControl_own_MCPInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c8_JointSpaceControl_own_MCP
      ((SFc8_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_JointSpaceControl_own_MCP
    ((SFc8_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_JointSpaceControl_own_MCP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_JointSpaceControl_own_MCP
      ((SFc8_JointSpaceControl_own_MCPInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_JointSpaceControl_own_MCP(SimStruct *S)
{
  SFc8_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc8_JointSpaceControl_own_MCPInstanceStruct *)utMalloc
    (sizeof(SFc8_JointSpaceControl_own_MCPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_JointSpaceControl_own_MCPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_JointSpaceControl_own_MCP;
...
void c8_JointSpaceControl_own_MCP_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_JointSpaceControl_own_MCP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_JointSpaceControl_own_MCP_method_dispatcher.\n"
