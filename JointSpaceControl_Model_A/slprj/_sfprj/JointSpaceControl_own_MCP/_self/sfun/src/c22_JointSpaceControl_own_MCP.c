...
static void initialize_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initialize_params_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void enable_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void disable_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c22_update_debugger_state_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void set_sim_state_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c22_st);
static void finalize_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void sf_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c22_chartstep_c22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initSimStructsc22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void registerMessagesc22_JointSpaceControl_own_MCP
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
...
static const mxArray *c22_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static void c22_emlrt_marshallIn(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c22_ddq, const char_T *c22_identifier, real_T
  c22_y[6]);
static void c22_b_emlrt_marshallIn(SFc22_JointSpaceControl_own_MCPInstanceStruct
...
static void c22_inv(SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance,
                    real_T c22_x[36], real_T c22_y[36]);
static void c22_invNxN(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c22_x[36], real_T c22_y[36]);
static void c22_realmin(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
static void c22_eps(SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c22_eml_matlab_zgetrf(SFc22_JointSpaceControl_own_MCPInstanceStruct *
  chartInstance, real_T c22_A[36], real_T c22_b_A[36], int32_T c22_ipiv[6],
  int32_T *c22_info);
static void c22_check_forloop_overflow_error
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance, boolean_T
   c22_overflow);
static void c22_eml_xger(SFc22_JointSpaceControl_own_MCPInstanceStruct
...
static void c22_eml_xtrsm(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c22_A[36], real_T c22_B[36], real_T c22_b_B[36]);
static real_T c22_norm(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c22_x[36]);
static void c22_eml_warning(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
static void c22_b_eml_warning(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, char_T c22_varargin_2[14]);
static void c22_eml_scalar_eg(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance);
static void c22_d_emlrt_marshallIn(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c22_sprintf, const char_T *c22_identifier,
  char_T c22_y[14]);
static void c22_e_emlrt_marshallIn(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId,
  char_T c22_y[14]);
static const mxArray *c22_d_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static int32_T c22_f_emlrt_marshallIn
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void c22_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData);
static uint8_T c22_g_emlrt_marshallIn
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c22_b_is_active_c22_JointSpaceControl_own_MCP, const char_T *c22_identifier);
static uint8_T c22_h_emlrt_marshallIn
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void c22_b_eml_matlab_zgetrf
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance, real_T c22_A[36],
   int32_T c22_ipiv[6], int32_T *c22_info);
static void c22_b_eml_xger(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, int32_T c22_m, int32_T c22_n, real_T c22_alpha1, int32_T
  c22_ix0, int32_T c22_iy0, real_T c22_A[36], int32_T c22_ia0);
static void c22_b_eml_xtrsm(SFc22_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, real_T c22_A[36], real_T c22_B[36]);
static void init_dsm_address_info(SFc22_JointSpaceControl_own_MCPInstanceStruct *
  chartInstance);
  ...
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c22_is_active_c22_JointSpaceControl_own_MCP = 0U;
}
  ...
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  c22_hoistedGlobal = chartInstance->c22_is_active_c22_JointSpaceControl_own_MCP;
   ...
   *c22_st)
{
  ...
  chartInstance->c22_is_active_c22_JointSpaceControl_own_MCP =
    c22_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c22_u, 1)),
    "is_active_c22_JointSpaceControl_own_MCP");
  sf_mex_destroy(&c22_u);
  c22_update_debugger_state_c22_JointSpaceControl_own_MCP(chartInstance);
  ...
  (SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c22_sfEvent = CALL_EVENT;
  c22_chartstep_c22_JointSpaceControl_own_MCP(chartInstance);
  ...
  *c22_inData)
{
  ...
  const mxArray *c22_y = NULL;
  SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc22_JointSpaceControl_own_MCPInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c22_JointSpaceControl_own_MCP_get_eml_resolved_functions_info
  (void)
{
   ...
   *c22_b_is_active_c22_JointSpaceControl_own_MCP, const char_T *c22_identifier)
{
  ...
  c22_y = c22_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c22_b_is_active_c22_JointSpaceControl_own_MCP), &c22_thisId);
  sf_mex_destroy(&c22_b_is_active_c22_JointSpaceControl_own_MCP);
  return c22_y;
}
...
void sf_c22_JointSpaceControl_own_MCP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c22_JointSpaceControl_own_MCP_get_autoinheritance_info(void)
{
...
mxArray *sf_c22_JointSpaceControl_own_MCP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c22_JointSpaceControl_own_MCP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[14],T\"ddq\",},{M[8],M[0],T\"is_active_c22_JointSpaceControl_own_MCP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c22_JointSpaceControl_own_MCP_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c22_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc22_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c22_JointSpaceControl_own_MCP
    ((SFc22_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
  initialize_c22_JointSpaceControl_own_MCP
    ((SFc22_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c22_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  enable_c22_JointSpaceControl_own_MCP
    ((SFc22_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c22_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  disable_c22_JointSpaceControl_own_MCP
    ((SFc22_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c22_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  sf_c22_JointSpaceControl_own_MCP
    ((SFc22_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c22_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c22_JointSpaceControl_own_MCP
    ((SFc22_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c22_JointSpaceControl_own_MCP();/* state var info */
...
extern void sf_internal_set_sim_state_c22_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c22_JointSpaceControl_own_MCP
    ((SFc22_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c22_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c22_JointSpaceControl_own_MCP(S);
}

static void sf_opaque_set_sim_state_c22_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c22_JointSpaceControl_own_MCP(S, st);
}

static void sf_opaque_terminate_c22_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc22_JointSpaceControl_own_MCPInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c22_JointSpaceControl_own_MCP
      ((SFc22_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc22_JointSpaceControl_own_MCP
    ((SFc22_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c22_JointSpaceControl_own_MCP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c22_JointSpaceControl_own_MCP
      ((SFc22_JointSpaceControl_own_MCPInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c22_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c22_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c22_JointSpaceControl_own_MCP(SimStruct *S)
{
  SFc22_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc22_JointSpaceControl_own_MCPInstanceStruct *)utMalloc
    (sizeof(SFc22_JointSpaceControl_own_MCPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc22_JointSpaceControl_own_MCPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlStart = mdlStart_c22_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c22_JointSpaceControl_own_MCP;
...
void c22_JointSpaceControl_own_MCP_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c22_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c22_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c22_JointSpaceControl_own_MCP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c22_JointSpaceControl_own_MCP_method_dispatcher.\n"
