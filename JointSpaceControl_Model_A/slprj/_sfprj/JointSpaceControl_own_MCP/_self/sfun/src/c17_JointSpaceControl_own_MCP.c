...
static void initialize_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initialize_params_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void enable_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void disable_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void set_sim_state_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c17_st);
static void finalize_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void sf_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void c17_chartstep_c17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void initSimStructsc17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
static void registerMessagesc17_JointSpaceControl_own_MCP
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_emlrt_marshallIn(SFc17_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c17_R, const char_T *c17_identifier, real_T
  c17_y[9]);
static void c17_b_emlrt_marshallIn(SFc17_JointSpaceControl_own_MCPInstanceStruct
...
static const mxArray *c17_b_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_c_emlrt_marshallIn(SFc17_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c17_d, const char_T *c17_identifier, real_T
  c17_y[3]);
static void c17_d_emlrt_marshallIn(SFc17_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId,
  real_T c17_y[3]);
...
static const mxArray *c17_e_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_f_emlrt_marshallIn(SFc17_JointSpaceControl_own_MCPInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId,
  real_T c17_y[16]);
...
static uint8_T c17_h_emlrt_marshallIn
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c17_b_is_active_c17_JointSpaceControl_own_MCP, const char_T *c17_identifier);
static uint8_T c17_i_emlrt_marshallIn
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance, const mxArray
   *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void init_dsm_address_info(SFc17_JointSpaceControl_own_MCPInstanceStruct *
  chartInstance);
  ...
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_JointSpaceControl_own_MCP = 0U;
}
  ...
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  c17_hoistedGlobal = chartInstance->c17_is_active_c17_JointSpaceControl_own_MCP;
   ...
   *c17_st)
{
  ...
  chartInstance->c17_is_active_c17_JointSpaceControl_own_MCP =
    c17_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c17_u, 2)),
    "is_active_c17_JointSpaceControl_own_MCP");
  sf_mex_destroy(&c17_u);
  c17_update_debugger_state_c17_JointSpaceControl_own_MCP(chartInstance);
  ...
  (SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_sfEvent = CALL_EVENT;
  c17_chartstep_c17_JointSpaceControl_own_MCP(chartInstance);
  ...
  *c17_inData)
{
  ...
  const mxArray *c17_y = NULL;
  SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc17_JointSpaceControl_own_MCPInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c17_JointSpaceControl_own_MCP_get_eml_resolved_functions_info
  (void)
{
   ...
   *c17_b_is_active_c17_JointSpaceControl_own_MCP, const char_T *c17_identifier)
{
  ...
  c17_y = c17_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c17_b_is_active_c17_JointSpaceControl_own_MCP), &c17_thisId);
  sf_mex_destroy(&c17_b_is_active_c17_JointSpaceControl_own_MCP);
  return c17_y;
}
...
void sf_c17_JointSpaceControl_own_MCP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c17_JointSpaceControl_own_MCP_get_autoinheritance_info(void)
{
...
mxArray *sf_c17_JointSpaceControl_own_MCP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c17_JointSpaceControl_own_MCP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[9],T\"R\",},{M[1],M[6],T\"d\",},{M[8],M[0],T\"is_active_c17_JointSpaceControl_own_MCP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_JointSpaceControl_own_MCP_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c17_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc17_JointSpaceControl_own_MCPInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c17_JointSpaceControl_own_MCP
    ((SFc17_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
  initialize_c17_JointSpaceControl_own_MCP
    ((SFc17_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c17_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  enable_c17_JointSpaceControl_own_MCP
    ((SFc17_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c17_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  disable_c17_JointSpaceControl_own_MCP
    ((SFc17_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c17_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  sf_c17_JointSpaceControl_own_MCP
    ((SFc17_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c17_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c17_JointSpaceControl_own_MCP
    ((SFc17_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c17_JointSpaceControl_own_MCP();/* state var info */
...
extern void sf_internal_set_sim_state_c17_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c17_JointSpaceControl_own_MCP
    ((SFc17_JointSpaceControl_own_MCPInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c17_JointSpaceControl_own_MCP
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c17_JointSpaceControl_own_MCP(S);
}

static void sf_opaque_set_sim_state_c17_JointSpaceControl_own_MCP(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c17_JointSpaceControl_own_MCP(S, st);
}

static void sf_opaque_terminate_c17_JointSpaceControl_own_MCP(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_JointSpaceControl_own_MCPInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c17_JointSpaceControl_own_MCP
      ((SFc17_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc17_JointSpaceControl_own_MCP
    ((SFc17_JointSpaceControl_own_MCPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_JointSpaceControl_own_MCP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c17_JointSpaceControl_own_MCP
      ((SFc17_JointSpaceControl_own_MCPInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c17_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c17_JointSpaceControl_own_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_JointSpaceControl_own_MCP(SimStruct *S)
{
  SFc17_JointSpaceControl_own_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc17_JointSpaceControl_own_MCPInstanceStruct *)utMalloc
    (sizeof(SFc17_JointSpaceControl_own_MCPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_JointSpaceControl_own_MCPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_JointSpaceControl_own_MCP;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c17_JointSpaceControl_own_MCP;
...
void c17_JointSpaceControl_own_MCP_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_JointSpaceControl_own_MCP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_JointSpaceControl_own_MCP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_JointSpaceControl_own_MCP_method_dispatcher.\n"
