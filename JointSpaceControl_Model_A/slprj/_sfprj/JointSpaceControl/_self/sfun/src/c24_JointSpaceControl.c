...
static void initialize_c24_JointSpaceControl
  (SFc24_JointSpaceControlInstanceStruct *chartInstance);
static void initialize_params_c24_JointSpaceControl
  (SFc24_JointSpaceControlInstanceStruct *chartInstance);
static void enable_c24_JointSpaceControl(SFc24_JointSpaceControlInstanceStruct
  *chartInstance);
static void disable_c24_JointSpaceControl(SFc24_JointSpaceControlInstanceStruct *
  chartInstance);
static void c24_update_debugger_state_c24_JointSpaceControl
  (SFc24_JointSpaceControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c24_JointSpaceControl
  (SFc24_JointSpaceControlInstanceStruct *chartInstance);
static void set_sim_state_c24_JointSpaceControl
  (SFc24_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c24_st);
static void finalize_c24_JointSpaceControl(SFc24_JointSpaceControlInstanceStruct
  *chartInstance);
static void sf_c24_JointSpaceControl(SFc24_JointSpaceControlInstanceStruct
  *chartInstance);
static void c24_chartstep_c24_JointSpaceControl
  (SFc24_JointSpaceControlInstanceStruct *chartInstance);
static void initSimStructsc24_JointSpaceControl
  (SFc24_JointSpaceControlInstanceStruct *chartInstance);
static void registerMessagesc24_JointSpaceControl
  (SFc24_JointSpaceControlInstanceStruct *chartInstance);
...
static const mxArray *c24_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_emlrt_marshallIn(SFc24_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c24_tau, const char_T *c24_identifier, real_T
  c24_y[6]);
static void c24_b_emlrt_marshallIn(SFc24_JointSpaceControlInstanceStruct
...
static const mxArray *c24_c_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static real_T c24_c_emlrt_marshallIn(SFc24_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData);
static void c24_eml_scalar_eg(SFc24_JointSpaceControlInstanceStruct
  *chartInstance);
static const mxArray *c24_d_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static int32_T c24_d_emlrt_marshallIn(SFc24_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData);
static uint8_T c24_e_emlrt_marshallIn(SFc24_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c24_b_is_active_c24_JointSpaceControl, const
  char_T *c24_identifier);
static uint8_T c24_f_emlrt_marshallIn(SFc24_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void init_dsm_address_info(SFc24_JointSpaceControlInstanceStruct
  *chartInstance);
  ...
  (SFc24_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_is_active_c24_JointSpaceControl = 0U;
}
  ...
  (SFc24_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  c24_hoistedGlobal = chartInstance->c24_is_active_c24_JointSpaceControl;
  ...
  (SFc24_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c24_st)
{
  ...
  chartInstance->c24_is_active_c24_JointSpaceControl = c24_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c24_u, 1)),
     "is_active_c24_JointSpaceControl");
  sf_mex_destroy(&c24_u);
  c24_update_debugger_state_c24_JointSpaceControl(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c24_sfEvent = CALL_EVENT;
  c24_chartstep_c24_JointSpaceControl(chartInstance);
  ...
  *c24_inData)
{
  ...
  const mxArray *c24_y = NULL;
  SFc24_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc24_JointSpaceControlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c24_JointSpaceControl_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c24_identifier)
{
  ...
  c24_y = c24_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c24_b_is_active_c24_JointSpaceControl), &c24_thisId);
  sf_mex_destroy(&c24_b_is_active_c24_JointSpaceControl);
  return c24_y;
}
...
void sf_c24_JointSpaceControl_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c24_JointSpaceControl_get_autoinheritance_info(void)
{
...
mxArray *sf_c24_JointSpaceControl_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c24_JointSpaceControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"tau\",},{M[8],M[0],T\"is_active_c24_JointSpaceControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_JointSpaceControl_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc24_JointSpaceControlInstanceStruct *chartInstance;
    chartInstance = (SFc24_JointSpaceControlInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c24_JointSpaceControl(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc24_JointSpaceControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c24_JointSpaceControl((SFc24_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
  initialize_c24_JointSpaceControl((SFc24_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c24_JointSpaceControl(void *chartInstanceVar)
{
  enable_c24_JointSpaceControl((SFc24_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c24_JointSpaceControl(void *chartInstanceVar)
{
  disable_c24_JointSpaceControl((SFc24_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c24_JointSpaceControl(void *chartInstanceVar)
{
  sf_c24_JointSpaceControl((SFc24_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c24_JointSpaceControl(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c24_JointSpaceControl
    ((SFc24_JointSpaceControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c24_JointSpaceControl();/* state var info */
...
extern void sf_internal_set_sim_state_c24_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c24_JointSpaceControl((SFc24_JointSpaceControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c24_JointSpaceControl(SimStruct* S)
{
  return sf_internal_get_sim_state_c24_JointSpaceControl(S);
}

static void sf_opaque_set_sim_state_c24_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c24_JointSpaceControl(S, st);
}

static void sf_opaque_terminate_c24_JointSpaceControl(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc24_JointSpaceControlInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c24_JointSpaceControl((SFc24_JointSpaceControlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc24_JointSpaceControl((SFc24_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_JointSpaceControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c24_JointSpaceControl
      ((SFc24_JointSpaceControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c24_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c24_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_JointSpaceControl(SimStruct *S)
{
  SFc24_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc24_JointSpaceControlInstanceStruct *)utMalloc(sizeof
    (SFc24_JointSpaceControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc24_JointSpaceControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c24_JointSpaceControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c24_JointSpaceControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c24_JointSpaceControl;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c24_JointSpaceControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c24_JointSpaceControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c24_JointSpaceControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c24_JointSpaceControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c24_JointSpaceControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c24_JointSpaceControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c24_JointSpaceControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c24_JointSpaceControl;
...
void c24_JointSpaceControl_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_JointSpaceControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_JointSpaceControl_method_dispatcher.\n"
