...
static void initialize_c15_JointSpaceControl
  (SFc15_JointSpaceControlInstanceStruct *chartInstance);
static void initialize_params_c15_JointSpaceControl
  (SFc15_JointSpaceControlInstanceStruct *chartInstance);
static void enable_c15_JointSpaceControl(SFc15_JointSpaceControlInstanceStruct
  *chartInstance);
static void disable_c15_JointSpaceControl(SFc15_JointSpaceControlInstanceStruct *
  chartInstance);
static void c15_update_debugger_state_c15_JointSpaceControl
  (SFc15_JointSpaceControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_JointSpaceControl
  (SFc15_JointSpaceControlInstanceStruct *chartInstance);
static void set_sim_state_c15_JointSpaceControl
  (SFc15_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c15_st);
static void finalize_c15_JointSpaceControl(SFc15_JointSpaceControlInstanceStruct
  *chartInstance);
static void sf_c15_JointSpaceControl(SFc15_JointSpaceControlInstanceStruct
  *chartInstance);
static void c15_chartstep_c15_JointSpaceControl
  (SFc15_JointSpaceControlInstanceStruct *chartInstance);
static void initSimStructsc15_JointSpaceControl
  (SFc15_JointSpaceControlInstanceStruct *chartInstance);
static void registerMessagesc15_JointSpaceControl
  (SFc15_JointSpaceControlInstanceStruct *chartInstance);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_emlrt_marshallIn(SFc15_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c15_R, const char_T *c15_identifier, real_T
  c15_y[9]);
static void c15_b_emlrt_marshallIn(SFc15_JointSpaceControlInstanceStruct
...
static const mxArray *c15_c_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_c_emlrt_marshallIn(SFc15_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static real_T c15_mpower(SFc15_JointSpaceControlInstanceStruct *chartInstance,
  real_T c15_a);
static void c15_eml_scalar_eg(SFc15_JointSpaceControlInstanceStruct
  *chartInstance);
static const mxArray *c15_d_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_d_emlrt_marshallIn(SFc15_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static uint8_T c15_e_emlrt_marshallIn(SFc15_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_JointSpaceControl, const
  char_T *c15_identifier);
static uint8_T c15_f_emlrt_marshallIn(SFc15_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void init_dsm_address_info(SFc15_JointSpaceControlInstanceStruct
  *chartInstance);
  ...
  (SFc15_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_JointSpaceControl = 0U;
}
  ...
  (SFc15_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  c15_hoistedGlobal = chartInstance->c15_is_active_c15_JointSpaceControl;
  ...
  (SFc15_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c15_st)
{
  ...
  chartInstance->c15_is_active_c15_JointSpaceControl = c15_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 1)),
     "is_active_c15_JointSpaceControl");
  sf_mex_destroy(&c15_u);
  c15_update_debugger_state_c15_JointSpaceControl(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c15_i2 = 0; c15_i2 < 3; c15_i2++) {
    _SFD_DATA_RANGE_CHECK((*c15_k)[c15_i2], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c15_theta, 1U);
  for (c15_i3 = 0; c15_i3 < 9; c15_i3++) {
    _SFD_DATA_RANGE_CHECK((*c15_R)[c15_i3], 2U);
  }

  chartInstance->c15_sfEvent = CALL_EVENT;
  c15_chartstep_c15_JointSpaceControl(chartInstance);
  ...
  *c15_inData)
{
  ...
  const mxArray *c15_y = NULL;
  SFc15_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc15_JointSpaceControlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_JointSpaceControl_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c15_identifier)
{
  ...
  c15_y = c15_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_JointSpaceControl), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_JointSpaceControl);
  return c15_y;
}
...
void sf_c15_JointSpaceControl_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_JointSpaceControl_get_autoinheritance_info(void)
{
...
mxArray *sf_c15_JointSpaceControl_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c15_JointSpaceControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"R\",},{M[8],M[0],T\"is_active_c15_JointSpaceControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_JointSpaceControl_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc15_JointSpaceControlInstanceStruct *chartInstance;
    chartInstance = (SFc15_JointSpaceControlInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c15_JointSpaceControl(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_JointSpaceControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c15_JointSpaceControl((SFc15_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
  initialize_c15_JointSpaceControl((SFc15_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c15_JointSpaceControl(void *chartInstanceVar)
{
  enable_c15_JointSpaceControl((SFc15_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c15_JointSpaceControl(void *chartInstanceVar)
{
  disable_c15_JointSpaceControl((SFc15_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c15_JointSpaceControl(void *chartInstanceVar)
{
  sf_c15_JointSpaceControl((SFc15_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_JointSpaceControl(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_JointSpaceControl
    ((SFc15_JointSpaceControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_JointSpaceControl();/* state var info */
...
extern void sf_internal_set_sim_state_c15_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c15_JointSpaceControl((SFc15_JointSpaceControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_JointSpaceControl(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_JointSpaceControl(S);
}

static void sf_opaque_set_sim_state_c15_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c15_JointSpaceControl(S, st);
}

static void sf_opaque_terminate_c15_JointSpaceControl(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_JointSpaceControlInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c15_JointSpaceControl((SFc15_JointSpaceControlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc15_JointSpaceControl((SFc15_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_JointSpaceControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c15_JointSpaceControl
      ((SFc15_JointSpaceControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c15_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c15_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_JointSpaceControl(SimStruct *S)
{
  SFc15_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc15_JointSpaceControlInstanceStruct *)utMalloc(sizeof
    (SFc15_JointSpaceControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_JointSpaceControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c15_JointSpaceControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c15_JointSpaceControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c15_JointSpaceControl;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_JointSpaceControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c15_JointSpaceControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c15_JointSpaceControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c15_JointSpaceControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_JointSpaceControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_JointSpaceControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_JointSpaceControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c15_JointSpaceControl;
...
void c15_JointSpaceControl_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_JointSpaceControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_JointSpaceControl_method_dispatcher.\n"
