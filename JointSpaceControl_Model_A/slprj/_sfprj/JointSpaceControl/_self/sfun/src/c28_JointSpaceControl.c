...
static void initialize_c28_JointSpaceControl
  (SFc28_JointSpaceControlInstanceStruct *chartInstance);
static void initialize_params_c28_JointSpaceControl
  (SFc28_JointSpaceControlInstanceStruct *chartInstance);
static void enable_c28_JointSpaceControl(SFc28_JointSpaceControlInstanceStruct
  *chartInstance);
static void disable_c28_JointSpaceControl(SFc28_JointSpaceControlInstanceStruct *
  chartInstance);
static void c28_update_debugger_state_c28_JointSpaceControl
  (SFc28_JointSpaceControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c28_JointSpaceControl
  (SFc28_JointSpaceControlInstanceStruct *chartInstance);
static void set_sim_state_c28_JointSpaceControl
  (SFc28_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c28_st);
static void finalize_c28_JointSpaceControl(SFc28_JointSpaceControlInstanceStruct
  *chartInstance);
static void sf_c28_JointSpaceControl(SFc28_JointSpaceControlInstanceStruct
  *chartInstance);
static void c28_chartstep_c28_JointSpaceControl
  (SFc28_JointSpaceControlInstanceStruct *chartInstance);
static void initSimStructsc28_JointSpaceControl
  (SFc28_JointSpaceControlInstanceStruct *chartInstance);
static void registerMessagesc28_JointSpaceControl
  (SFc28_JointSpaceControlInstanceStruct *chartInstance);
...
static const mxArray *c28_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static void c28_emlrt_marshallIn(SFc28_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c28_G_Version1, const char_T *c28_identifier,
  real_T c28_y[6]);
static void c28_b_emlrt_marshallIn(SFc28_JointSpaceControlInstanceStruct
...
static const mxArray *c28_b_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static real_T c28_c_emlrt_marshallIn(SFc28_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
...
static const mxArray *c28_c_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static int32_T c28_d_emlrt_marshallIn(SFc28_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
static void c28_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c28_mxArrayInData, const char_T *c28_varName, void *c28_outData);
static uint8_T c28_e_emlrt_marshallIn(SFc28_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c28_b_is_active_c28_JointSpaceControl, const
  char_T *c28_identifier);
static uint8_T c28_f_emlrt_marshallIn(SFc28_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
static void init_dsm_address_info(SFc28_JointSpaceControlInstanceStruct
  *chartInstance);
  ...
  (SFc28_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c28_is_active_c28_JointSpaceControl = 0U;
}
  ...
  (SFc28_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  c28_hoistedGlobal = chartInstance->c28_is_active_c28_JointSpaceControl;
  ...
  (SFc28_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c28_st)
{
  ...
  chartInstance->c28_is_active_c28_JointSpaceControl = c28_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c28_u, 1)),
     "is_active_c28_JointSpaceControl");
  sf_mex_destroy(&c28_u);
  c28_update_debugger_state_c28_JointSpaceControl(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c28_sfEvent = CALL_EVENT;
  c28_chartstep_c28_JointSpaceControl(chartInstance);
  ...
  *c28_inData)
{
  ...
  const mxArray *c28_y = NULL;
  SFc28_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc28_JointSpaceControlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c28_JointSpaceControl_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c28_identifier)
{
  ...
  c28_y = c28_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c28_b_is_active_c28_JointSpaceControl), &c28_thisId);
  sf_mex_destroy(&c28_b_is_active_c28_JointSpaceControl);
  return c28_y;
}
...
void sf_c28_JointSpaceControl_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c28_JointSpaceControl_get_autoinheritance_info(void)
{
...
mxArray *sf_c28_JointSpaceControl_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c28_JointSpaceControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"G_Version1\",},{M[8],M[0],T\"is_active_c28_JointSpaceControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c28_JointSpaceControl_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc28_JointSpaceControlInstanceStruct *chartInstance;
    chartInstance = (SFc28_JointSpaceControlInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c28_JointSpaceControl(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc28_JointSpaceControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c28_JointSpaceControl((SFc28_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
  initialize_c28_JointSpaceControl((SFc28_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c28_JointSpaceControl(void *chartInstanceVar)
{
  enable_c28_JointSpaceControl((SFc28_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c28_JointSpaceControl(void *chartInstanceVar)
{
  disable_c28_JointSpaceControl((SFc28_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c28_JointSpaceControl(void *chartInstanceVar)
{
  sf_c28_JointSpaceControl((SFc28_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c28_JointSpaceControl(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c28_JointSpaceControl
    ((SFc28_JointSpaceControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c28_JointSpaceControl();/* state var info */
...
extern void sf_internal_set_sim_state_c28_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c28_JointSpaceControl((SFc28_JointSpaceControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c28_JointSpaceControl(SimStruct* S)
{
  return sf_internal_get_sim_state_c28_JointSpaceControl(S);
}

static void sf_opaque_set_sim_state_c28_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c28_JointSpaceControl(S, st);
}

static void sf_opaque_terminate_c28_JointSpaceControl(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc28_JointSpaceControlInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c28_JointSpaceControl((SFc28_JointSpaceControlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc28_JointSpaceControl((SFc28_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c28_JointSpaceControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c28_JointSpaceControl
      ((SFc28_JointSpaceControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c28_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c28_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c28_JointSpaceControl(SimStruct *S)
{
  SFc28_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc28_JointSpaceControlInstanceStruct *)utMalloc(sizeof
    (SFc28_JointSpaceControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc28_JointSpaceControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c28_JointSpaceControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c28_JointSpaceControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c28_JointSpaceControl;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c28_JointSpaceControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c28_JointSpaceControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c28_JointSpaceControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c28_JointSpaceControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c28_JointSpaceControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c28_JointSpaceControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c28_JointSpaceControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c28_JointSpaceControl;
...
void c28_JointSpaceControl_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c28_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c28_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c28_JointSpaceControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c28_JointSpaceControl_method_dispatcher.\n"
