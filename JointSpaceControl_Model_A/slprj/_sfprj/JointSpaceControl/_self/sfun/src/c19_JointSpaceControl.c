...
static void initialize_c19_JointSpaceControl
  (SFc19_JointSpaceControlInstanceStruct *chartInstance);
static void initialize_params_c19_JointSpaceControl
  (SFc19_JointSpaceControlInstanceStruct *chartInstance);
static void enable_c19_JointSpaceControl(SFc19_JointSpaceControlInstanceStruct
  *chartInstance);
static void disable_c19_JointSpaceControl(SFc19_JointSpaceControlInstanceStruct *
  chartInstance);
static void c19_update_debugger_state_c19_JointSpaceControl
  (SFc19_JointSpaceControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_JointSpaceControl
  (SFc19_JointSpaceControlInstanceStruct *chartInstance);
static void set_sim_state_c19_JointSpaceControl
  (SFc19_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c19_st);
static void finalize_c19_JointSpaceControl(SFc19_JointSpaceControlInstanceStruct
  *chartInstance);
static void sf_c19_JointSpaceControl(SFc19_JointSpaceControlInstanceStruct
  *chartInstance);
static void c19_chartstep_c19_JointSpaceControl
  (SFc19_JointSpaceControlInstanceStruct *chartInstance);
static void initSimStructsc19_JointSpaceControl
  (SFc19_JointSpaceControlInstanceStruct *chartInstance);
static void registerMessagesc19_JointSpaceControl
  (SFc19_JointSpaceControlInstanceStruct *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_emlrt_marshallIn(SFc19_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c19_ddX, const char_T *c19_identifier, real_T
  c19_y[6]);
static void c19_b_emlrt_marshallIn(SFc19_JointSpaceControlInstanceStruct
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_c_emlrt_marshallIn(SFc19_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static void c19_eml_scalar_eg(SFc19_JointSpaceControlInstanceStruct
  *chartInstance);
static const mxArray *c19_d_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_d_emlrt_marshallIn(SFc19_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint8_T c19_e_emlrt_marshallIn(SFc19_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c19_b_is_active_c19_JointSpaceControl, const
  char_T *c19_identifier);
static uint8_T c19_f_emlrt_marshallIn(SFc19_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void init_dsm_address_info(SFc19_JointSpaceControlInstanceStruct
  *chartInstance);
  ...
  (SFc19_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_JointSpaceControl = 0U;
}
  ...
  (SFc19_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  c19_hoistedGlobal = chartInstance->c19_is_active_c19_JointSpaceControl;
  ...
  (SFc19_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c19_st)
{
  ...
  chartInstance->c19_is_active_c19_JointSpaceControl = c19_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 1)),
     "is_active_c19_JointSpaceControl");
  sf_mex_destroy(&c19_u);
  c19_update_debugger_state_c19_JointSpaceControl(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c19_sfEvent = CALL_EVENT;
  c19_chartstep_c19_JointSpaceControl(chartInstance);
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_y = NULL;
  SFc19_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc19_JointSpaceControlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c19_JointSpaceControl_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c19_identifier)
{
  ...
  c19_y = c19_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c19_b_is_active_c19_JointSpaceControl), &c19_thisId);
  sf_mex_destroy(&c19_b_is_active_c19_JointSpaceControl);
  return c19_y;
}
...
void sf_c19_JointSpaceControl_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c19_JointSpaceControl_get_autoinheritance_info(void)
{
...
mxArray *sf_c19_JointSpaceControl_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c19_JointSpaceControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[12],T\"ddX\",},{M[8],M[0],T\"is_active_c19_JointSpaceControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_JointSpaceControl_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc19_JointSpaceControlInstanceStruct *chartInstance;
    chartInstance = (SFc19_JointSpaceControlInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c19_JointSpaceControl(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_JointSpaceControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c19_JointSpaceControl((SFc19_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
  initialize_c19_JointSpaceControl((SFc19_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c19_JointSpaceControl(void *chartInstanceVar)
{
  enable_c19_JointSpaceControl((SFc19_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c19_JointSpaceControl(void *chartInstanceVar)
{
  disable_c19_JointSpaceControl((SFc19_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c19_JointSpaceControl(void *chartInstanceVar)
{
  sf_c19_JointSpaceControl((SFc19_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c19_JointSpaceControl(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c19_JointSpaceControl
    ((SFc19_JointSpaceControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c19_JointSpaceControl();/* state var info */
...
extern void sf_internal_set_sim_state_c19_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c19_JointSpaceControl((SFc19_JointSpaceControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c19_JointSpaceControl(SimStruct* S)
{
  return sf_internal_get_sim_state_c19_JointSpaceControl(S);
}

static void sf_opaque_set_sim_state_c19_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c19_JointSpaceControl(S, st);
}

static void sf_opaque_terminate_c19_JointSpaceControl(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_JointSpaceControlInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c19_JointSpaceControl((SFc19_JointSpaceControlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc19_JointSpaceControl((SFc19_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_JointSpaceControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c19_JointSpaceControl
      ((SFc19_JointSpaceControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c19_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c19_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_JointSpaceControl(SimStruct *S)
{
  SFc19_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc19_JointSpaceControlInstanceStruct *)utMalloc(sizeof
    (SFc19_JointSpaceControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_JointSpaceControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c19_JointSpaceControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c19_JointSpaceControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c19_JointSpaceControl;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c19_JointSpaceControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c19_JointSpaceControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c19_JointSpaceControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c19_JointSpaceControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_JointSpaceControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_JointSpaceControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_JointSpaceControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c19_JointSpaceControl;
...
void c19_JointSpaceControl_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_JointSpaceControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_JointSpaceControl_method_dispatcher.\n"
