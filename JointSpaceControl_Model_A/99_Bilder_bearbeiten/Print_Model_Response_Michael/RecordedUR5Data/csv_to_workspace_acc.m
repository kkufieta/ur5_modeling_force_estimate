...
csv_folder_name = 'Movement_No3_Acc/csv_files/';
mat_folder_name = 'Movement_No3_Acc/mat_files/';
...
acceleration = struct('time', accelerometer(:,1)*0.001, ...
                  'signals', struct('values', accelerometer(:,2:end)));
