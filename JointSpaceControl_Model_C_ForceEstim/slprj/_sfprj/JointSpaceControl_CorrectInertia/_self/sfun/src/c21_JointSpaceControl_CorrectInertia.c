...
static void initialize_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void initialize_params_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void enable_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void disable_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void set_sim_state_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, const
   mxArray *c21_st);
static void finalize_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void sf_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void c21_chartstep_c21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void initSimStructsc21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void registerMessagesc21_JointSpaceControl_CorrectInertia
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
...
static void c21_invNxN(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct
  *chartInstance, real_T c21_x[36], real_T c21_y[36]);
static void c21_realmin(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct
  *chartInstance);
static void c21_eps(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct
                    *chartInstance);
static void c21_eml_matlab_zgetrf
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, real_T
...
static void c21_eml_xger(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct
...
static void c21_eml_xtrsm(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct
  *chartInstance, real_T c21_A[36], real_T c21_B[36], real_T c21_b_B[36]);
static real_T c21_norm(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct
  *chartInstance, real_T c21_x[36]);
static void c21_eml_warning(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct
  *chartInstance);
static void c21_b_eml_warning
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, char_T
   c21_varargin_2[14]);
...
static uint8_T c21_g_emlrt_marshallIn
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, const
   mxArray *c21_b_is_active_c21_JointSpaceControl_CorrectInertia, const char_T
   *c21_identifier);
...
static void c21_b_eml_xger(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *
  chartInstance, int32_T c21_m, int32_T c21_n, real_T c21_alpha1, int32_T
  c21_ix0, int32_T c21_iy0, real_T c21_A[36], int32_T c21_ia0);
static void c21_b_eml_xtrsm(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct
  ...
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_JointSpaceControl_CorrectInertia = 0U;
}
  ...
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance)
{
  ...
  c21_hoistedGlobal =
    chartInstance->c21_is_active_c21_JointSpaceControl_CorrectInertia;
   ...
   mxArray *c21_st)
{
  ...
  chartInstance->c21_is_active_c21_JointSpaceControl_CorrectInertia =
    ...
    "is_active_c21_JointSpaceControl_CorrectInertia");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_JointSpaceControl_CorrectInertia(chartInstance);
  ...
  (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_sfEvent = CALL_EVENT;
  c21_chartstep_c21_JointSpaceControl_CorrectInertia(chartInstance);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c21_JointSpaceControl_CorrectInertia_get_eml_resolved_functions_info(void)
{
   ...
   *c21_identifier)
{
  ...
  c21_y = c21_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_JointSpaceControl_CorrectInertia), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_JointSpaceControl_CorrectInertia);
  return c21_y;
}
...
void sf_c21_JointSpaceControl_CorrectInertia_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_JointSpaceControl_CorrectInertia_get_autoinheritance_info(void)
{
...
mxArray *sf_c21_JointSpaceControl_CorrectInertia_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c21_JointSpaceControl_CorrectInertia
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"dq\",},{M[8],M[0],T\"is_active_c21_JointSpaceControl_CorrectInertia\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_JointSpaceControl_CorrectInertia_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c21_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c21_JointSpaceControl_CorrectInertia
    ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
  initialize_c21_JointSpaceControl_CorrectInertia
    ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  enable_c21_JointSpaceControl_CorrectInertia
    ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  disable_c21_JointSpaceControl_CorrectInertia
    ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  sf_c21_JointSpaceControl_CorrectInertia
    ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c21_JointSpaceControl_CorrectInertia(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_JointSpaceControl_CorrectInertia
    ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c21_JointSpaceControl_CorrectInertia();/* state var info */
...
extern void sf_internal_set_sim_state_c21_JointSpaceControl_CorrectInertia
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c21_JointSpaceControl_CorrectInertia
    ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c21_JointSpaceControl_CorrectInertia(SimStruct* S)
{
  return sf_internal_get_sim_state_c21_JointSpaceControl_CorrectInertia(S);
}

static void sf_opaque_set_sim_state_c21_JointSpaceControl_CorrectInertia
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c21_JointSpaceControl_CorrectInertia(S, st);
}

static void sf_opaque_terminate_c21_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c21_JointSpaceControl_CorrectInertia
      ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_JointSpaceControl_CorrectInertia
    ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_JointSpaceControl_CorrectInertia(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c21_JointSpaceControl_CorrectInertia
      ((SFc21_JointSpaceControl_CorrectInertiaInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c21_JointSpaceControl_CorrectInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c21_JointSpaceControl_CorrectInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_JointSpaceControl_CorrectInertia(SimStruct *S)
{
  SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc21_JointSpaceControl_CorrectInertiaInstanceStruct *)
    utMalloc(sizeof(SFc21_JointSpaceControl_CorrectInertiaInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c21_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c21_JointSpaceControl_CorrectInertia;
...
void c21_JointSpaceControl_CorrectInertia_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_JointSpaceControl_CorrectInertia(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_JointSpaceControl_CorrectInertia(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_JointSpaceControl_CorrectInertia(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_JointSpaceControl_CorrectInertia_method_dispatcher.\n"
