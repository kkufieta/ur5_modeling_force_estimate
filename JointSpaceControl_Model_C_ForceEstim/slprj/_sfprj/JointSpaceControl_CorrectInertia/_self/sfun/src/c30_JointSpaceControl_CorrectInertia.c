...
static void initialize_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void initialize_params_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void enable_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void disable_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void c30_update_debugger_state_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void set_sim_state_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, const
   mxArray *c30_st);
static void finalize_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void sf_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void c30_chartstep_c30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void initSimStructsc30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
static void registerMessagesc30_JointSpaceControl_CorrectInertia
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance);
...
static const mxArray *c30_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_emlrt_marshallIn
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, const
   mxArray *c30_tau_G, const char_T *c30_identifier, real_T c30_y[6]);
static void c30_b_emlrt_marshallIn
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, const
   mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[6]);
...
static uint8_T c30_e_emlrt_marshallIn
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance, const
   mxArray *c30_b_is_active_c30_JointSpaceControl_CorrectInertia, const char_T
   *c30_identifier);
  ...
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c30_is_active_c30_JointSpaceControl_CorrectInertia = 0U;
}
  ...
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance)
{
  ...
  c30_hoistedGlobal =
    chartInstance->c30_is_active_c30_JointSpaceControl_CorrectInertia;
   ...
   mxArray *c30_st)
{
  ...
  chartInstance->c30_is_active_c30_JointSpaceControl_CorrectInertia =
    ...
    "is_active_c30_JointSpaceControl_CorrectInertia");
  sf_mex_destroy(&c30_u);
  c30_update_debugger_state_c30_JointSpaceControl_CorrectInertia(chartInstance);
  ...
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 28U, chartInstance->c30_sfEvent);
  ...
  chartInstance->c30_sfEvent = CALL_EVENT;
  c30_chartstep_c30_JointSpaceControl_CorrectInertia(chartInstance);
  ...
  (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 28U, chartInstance->c30_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 28U, chartInstance->c30_sfEvent);
}
  ...
  *c30_inData)
{
  ...
  const mxArray *c30_y = NULL;
  SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c30_JointSpaceControl_CorrectInertia_get_eml_resolved_functions_info(void)
{
   ...
   *c30_identifier)
{
  ...
  c30_y = c30_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c30_b_is_active_c30_JointSpaceControl_CorrectInertia), &c30_thisId);
  sf_mex_destroy(&c30_b_is_active_c30_JointSpaceControl_CorrectInertia);
  return c30_y;
}
...
void sf_c30_JointSpaceControl_CorrectInertia_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c30_JointSpaceControl_CorrectInertia_get_autoinheritance_info(void)
{
...
mxArray *sf_c30_JointSpaceControl_CorrectInertia_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c30_JointSpaceControl_CorrectInertia
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[8],T\"tau\",},{M[1],M[10],T\"tau_CDq\",},{M[1],M[11],T\"tau_G\",},{M[1],M[9],T\"tau_M\",},{M[8],M[0],T\"is_active_c30_JointSpaceControl_CorrectInertia\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c30_JointSpaceControl_CorrectInertia_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c30_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c30_JointSpaceControl_CorrectInertia
    ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
  initialize_c30_JointSpaceControl_CorrectInertia
    ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c30_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  enable_c30_JointSpaceControl_CorrectInertia
    ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c30_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  disable_c30_JointSpaceControl_CorrectInertia
    ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c30_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  sf_c30_JointSpaceControl_CorrectInertia
    ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c30_JointSpaceControl_CorrectInertia(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c30_JointSpaceControl_CorrectInertia
    ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c30_JointSpaceControl_CorrectInertia();/* state var info */
...
extern void sf_internal_set_sim_state_c30_JointSpaceControl_CorrectInertia
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c30_JointSpaceControl_CorrectInertia
    ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c30_JointSpaceControl_CorrectInertia(SimStruct* S)
{
  return sf_internal_get_sim_state_c30_JointSpaceControl_CorrectInertia(S);
}

static void sf_opaque_set_sim_state_c30_JointSpaceControl_CorrectInertia
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c30_JointSpaceControl_CorrectInertia(S, st);
}

static void sf_opaque_terminate_c30_JointSpaceControl_CorrectInertia(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c30_JointSpaceControl_CorrectInertia
      ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc30_JointSpaceControl_CorrectInertia
    ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c30_JointSpaceControl_CorrectInertia(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c30_JointSpaceControl_CorrectInertia
      ((SFc30_JointSpaceControl_CorrectInertiaInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c30_JointSpaceControl_CorrectInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c30_JointSpaceControl_CorrectInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c30_JointSpaceControl_CorrectInertia(SimStruct *S)
{
  SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc30_JointSpaceControl_CorrectInertiaInstanceStruct *)
    utMalloc(sizeof(SFc30_JointSpaceControl_CorrectInertiaInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c30_JointSpaceControl_CorrectInertia;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c30_JointSpaceControl_CorrectInertia;
...
void c30_JointSpaceControl_CorrectInertia_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c30_JointSpaceControl_CorrectInertia(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c30_JointSpaceControl_CorrectInertia(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c30_JointSpaceControl_CorrectInertia(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c30_JointSpaceControl_CorrectInertia_method_dispatcher.\n"
