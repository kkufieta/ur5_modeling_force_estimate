...
static void initialize_c12_JointSpaceControl
  (SFc12_JointSpaceControlInstanceStruct *chartInstance);
static void initialize_params_c12_JointSpaceControl
  (SFc12_JointSpaceControlInstanceStruct *chartInstance);
static void enable_c12_JointSpaceControl(SFc12_JointSpaceControlInstanceStruct
  *chartInstance);
static void disable_c12_JointSpaceControl(SFc12_JointSpaceControlInstanceStruct *
  chartInstance);
static void c12_update_debugger_state_c12_JointSpaceControl
  (SFc12_JointSpaceControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_JointSpaceControl
  (SFc12_JointSpaceControlInstanceStruct *chartInstance);
static void set_sim_state_c12_JointSpaceControl
  (SFc12_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c12_st);
static void finalize_c12_JointSpaceControl(SFc12_JointSpaceControlInstanceStruct
  *chartInstance);
static void sf_c12_JointSpaceControl(SFc12_JointSpaceControlInstanceStruct
  *chartInstance);
static void initSimStructsc12_JointSpaceControl
  (SFc12_JointSpaceControlInstanceStruct *chartInstance);
static void registerMessagesc12_JointSpaceControl
  (SFc12_JointSpaceControlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_emlrt_marshallIn(SFc12_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c12_theta, const char_T *c12_identifier);
static real_T c12_b_emlrt_marshallIn(SFc12_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_b_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_c_emlrt_marshallIn(SFc12_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c12_k, const char_T *c12_identifier, real_T
  c12_y[3]);
static void c12_d_emlrt_marshallIn(SFc12_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[3]);
...
static void c12_eml_scalar_eg(SFc12_JointSpaceControlInstanceStruct
  *chartInstance);
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_e_emlrt_marshallIn(SFc12_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_f_emlrt_marshallIn(SFc12_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_JointSpaceControl, const
  char_T *c12_identifier);
static uint8_T c12_g_emlrt_marshallIn(SFc12_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_JointSpaceControlInstanceStruct
  *chartInstance);
  ...
  (SFc12_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_JointSpaceControl = 0U;
}
  ...
  (SFc12_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  c12_b_hoistedGlobal = chartInstance->c12_is_active_c12_JointSpaceControl;
  ...
  (SFc12_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c12_st)
{
  ...
  *c12_theta = c12_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c12_u, 1)), "theta");
  chartInstance->c12_is_active_c12_JointSpaceControl = c12_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 2)),
     "is_active_c12_JointSpaceControl");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_JointSpaceControl(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc12_JointSpaceControlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_JointSpaceControl_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c12_identifier)
{
  ...
  c12_y = c12_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_JointSpaceControl), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_JointSpaceControl);
  return c12_y;
}
...
void sf_c12_JointSpaceControl_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_JointSpaceControl_get_autoinheritance_info(void)
{
...
mxArray *sf_c12_JointSpaceControl_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c12_JointSpaceControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"k\",},{M[1],M[6],T\"theta\",},{M[8],M[0],T\"is_active_c12_JointSpaceControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_JointSpaceControl_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc12_JointSpaceControlInstanceStruct *chartInstance;
    chartInstance = (SFc12_JointSpaceControlInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c12_JointSpaceControl(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_JointSpaceControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_JointSpaceControl((SFc12_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
  initialize_c12_JointSpaceControl((SFc12_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c12_JointSpaceControl(void *chartInstanceVar)
{
  enable_c12_JointSpaceControl((SFc12_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c12_JointSpaceControl(void *chartInstanceVar)
{
  disable_c12_JointSpaceControl((SFc12_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c12_JointSpaceControl(void *chartInstanceVar)
{
  sf_c12_JointSpaceControl((SFc12_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_JointSpaceControl(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_JointSpaceControl
    ((SFc12_JointSpaceControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_JointSpaceControl();/* state var info */
...
extern void sf_internal_set_sim_state_c12_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c12_JointSpaceControl((SFc12_JointSpaceControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_JointSpaceControl(SimStruct* S)
{
  return sf_internal_get_sim_state_c12_JointSpaceControl(S);
}

static void sf_opaque_set_sim_state_c12_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c12_JointSpaceControl(S, st);
}

static void sf_opaque_terminate_c12_JointSpaceControl(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_JointSpaceControlInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c12_JointSpaceControl((SFc12_JointSpaceControlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc12_JointSpaceControl((SFc12_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_JointSpaceControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c12_JointSpaceControl
      ((SFc12_JointSpaceControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c12_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_JointSpaceControl(SimStruct *S)
{
  SFc12_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc12_JointSpaceControlInstanceStruct *)utMalloc(sizeof
    (SFc12_JointSpaceControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_JointSpaceControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_JointSpaceControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_JointSpaceControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_JointSpaceControl;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_JointSpaceControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_JointSpaceControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_JointSpaceControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_JointSpaceControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_JointSpaceControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_JointSpaceControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_JointSpaceControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_JointSpaceControl;
...
void c12_JointSpaceControl_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_JointSpaceControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_JointSpaceControl_method_dispatcher.\n"
