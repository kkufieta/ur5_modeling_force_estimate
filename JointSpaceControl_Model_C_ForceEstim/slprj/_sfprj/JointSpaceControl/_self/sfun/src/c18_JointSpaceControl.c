...
static void initialize_c18_JointSpaceControl
  (SFc18_JointSpaceControlInstanceStruct *chartInstance);
static void initialize_params_c18_JointSpaceControl
  (SFc18_JointSpaceControlInstanceStruct *chartInstance);
static void enable_c18_JointSpaceControl(SFc18_JointSpaceControlInstanceStruct
  *chartInstance);
static void disable_c18_JointSpaceControl(SFc18_JointSpaceControlInstanceStruct *
  chartInstance);
static void c18_update_debugger_state_c18_JointSpaceControl
  (SFc18_JointSpaceControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_JointSpaceControl
  (SFc18_JointSpaceControlInstanceStruct *chartInstance);
static void set_sim_state_c18_JointSpaceControl
  (SFc18_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c18_st);
static void finalize_c18_JointSpaceControl(SFc18_JointSpaceControlInstanceStruct
  *chartInstance);
static void sf_c18_JointSpaceControl(SFc18_JointSpaceControlInstanceStruct
  *chartInstance);
static void initSimStructsc18_JointSpaceControl
  (SFc18_JointSpaceControlInstanceStruct *chartInstance);
static void registerMessagesc18_JointSpaceControl
  (SFc18_JointSpaceControlInstanceStruct *chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static void c18_emlrt_marshallIn(SFc18_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c18_R, const char_T *c18_identifier, real_T
  c18_y[9]);
static void c18_b_emlrt_marshallIn(SFc18_JointSpaceControlInstanceStruct
...
static const mxArray *c18_b_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_c_emlrt_marshallIn(SFc18_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
...
static const mxArray *c18_c_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_d_emlrt_marshallIn(SFc18_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_e_emlrt_marshallIn(SFc18_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_JointSpaceControl, const
  char_T *c18_identifier);
static uint8_T c18_f_emlrt_marshallIn(SFc18_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void init_dsm_address_info(SFc18_JointSpaceControlInstanceStruct
  *chartInstance);
  ...
  (SFc18_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_JointSpaceControl = 0U;
}
  ...
  (SFc18_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  c18_hoistedGlobal = chartInstance->c18_is_active_c18_JointSpaceControl;
  ...
  (SFc18_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c18_st)
{
  ...
  chartInstance->c18_is_active_c18_JointSpaceControl = c18_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 1)),
     "is_active_c18_JointSpaceControl");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_JointSpaceControl(chartInstance);
  ...
  *c18_inData)
{
  ...
  const mxArray *c18_y = NULL;
  SFc18_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc18_JointSpaceControlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c18_JointSpaceControl_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c18_identifier)
{
  ...
  c18_y = c18_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_JointSpaceControl), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_JointSpaceControl);
  return c18_y;
}
...
void sf_c18_JointSpaceControl_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c18_JointSpaceControl_get_autoinheritance_info(void)
{
...
mxArray *sf_c18_JointSpaceControl_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c18_JointSpaceControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"R\",},{M[8],M[0],T\"is_active_c18_JointSpaceControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_JointSpaceControl_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc18_JointSpaceControlInstanceStruct *chartInstance;
    chartInstance = (SFc18_JointSpaceControlInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c18_JointSpaceControl(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_JointSpaceControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c18_JointSpaceControl((SFc18_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
  initialize_c18_JointSpaceControl((SFc18_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c18_JointSpaceControl(void *chartInstanceVar)
{
  enable_c18_JointSpaceControl((SFc18_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c18_JointSpaceControl(void *chartInstanceVar)
{
  disable_c18_JointSpaceControl((SFc18_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c18_JointSpaceControl(void *chartInstanceVar)
{
  sf_c18_JointSpaceControl((SFc18_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c18_JointSpaceControl(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_JointSpaceControl
    ((SFc18_JointSpaceControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_JointSpaceControl();/* state var info */
...
extern void sf_internal_set_sim_state_c18_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c18_JointSpaceControl((SFc18_JointSpaceControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c18_JointSpaceControl(SimStruct* S)
{
  return sf_internal_get_sim_state_c18_JointSpaceControl(S);
}

static void sf_opaque_set_sim_state_c18_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c18_JointSpaceControl(S, st);
}

static void sf_opaque_terminate_c18_JointSpaceControl(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_JointSpaceControlInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c18_JointSpaceControl((SFc18_JointSpaceControlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc18_JointSpaceControl((SFc18_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_JointSpaceControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c18_JointSpaceControl
      ((SFc18_JointSpaceControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c18_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c18_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_JointSpaceControl(SimStruct *S)
{
  SFc18_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc18_JointSpaceControlInstanceStruct *)utMalloc(sizeof
    (SFc18_JointSpaceControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_JointSpaceControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_JointSpaceControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_JointSpaceControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_JointSpaceControl;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c18_JointSpaceControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c18_JointSpaceControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_JointSpaceControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_JointSpaceControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_JointSpaceControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_JointSpaceControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_JointSpaceControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c18_JointSpaceControl;
...
void c18_JointSpaceControl_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_JointSpaceControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_JointSpaceControl_method_dispatcher.\n"
