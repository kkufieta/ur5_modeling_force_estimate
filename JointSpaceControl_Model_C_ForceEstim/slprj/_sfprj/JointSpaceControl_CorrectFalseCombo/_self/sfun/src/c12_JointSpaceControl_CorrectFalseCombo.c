...
static void initialize_c12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void initialize_params_c12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void enable_c12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void disable_c12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_JointSpaceControl_CorrectFalseComb
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void set_sim_state_c12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance, const
   mxArray *c12_st);
static void finalize_c12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void sf_c12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void initSimStructsc12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void registerMessagesc12_JointSpaceControl_CorrectFalseCombo
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
...
static uint8_T c12_f_emlrt_marshallIn
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance, const
   mxArray *c12_b_is_active_c12_JointSpaceControl_CorrectFalseCombo, const
  ...
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_JointSpaceControl_CorrectFalseCombo = 0U;
}
  ...
  (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance)
{
  ...
  c12_b_hoistedGlobal =
    chartInstance->c12_is_active_c12_JointSpaceControl_CorrectFalseCombo;
   ...
   mxArray *c12_st)
{
  ...
  *c12_theta = c12_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c12_is_active_c12_JointSpaceControl_CorrectFalseCombo =
    ...
    "is_active_c12_JointSpaceControl_CorrectFalseCombo");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_JointSpaceControl_CorrectFalseComb(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance;
  chartInstance = (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *)
    chartInstanceVoid;
   ...
   char_T *c12_identifier)
{
  ...
  c12_y = c12_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_JointSpaceControl_CorrectFalseCombo), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_JointSpaceControl_CorrectFalseCombo);
  return c12_y;
}
...
void sf_c12_JointSpaceControl_CorrectFalseCombo_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_JointSpaceControl_CorrectFalseCombo_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c12_JointSpaceControl_CorrectFalseCombo_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c12_JointSpaceControl_CorrectFalseCombo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"k\",},{M[1],M[6],T\"theta\",},{M[8],M[0],T\"is_active_c12_JointSpaceControl_CorrectFalseCombo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_JointSpaceControl_CorrectFalseCombo_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c12_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c12_JointSpaceControl_CorrectFalseCombo
    ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
  initialize_c12_JointSpaceControl_CorrectFalseCombo
    ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  enable_c12_JointSpaceControl_CorrectFalseCombo
    ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  disable_c12_JointSpaceControl_CorrectFalseCombo
    ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  sf_c12_JointSpaceControl_CorrectFalseCombo
    ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c12_JointSpaceControl_CorrectFalseCombo(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_JointSpaceControl_CorrectFalseCombo
    ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c12_JointSpaceControl_CorrectFalseCombo();/* state var info */
...
extern void sf_internal_set_sim_state_c12_JointSpaceControl_CorrectFalseCombo
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c12_JointSpaceControl_CorrectFalseCombo
    ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c12_JointSpaceControl_CorrectFalseCombo(SimStruct* S)
{
  return sf_internal_get_sim_state_c12_JointSpaceControl_CorrectFalseCombo(S);
}

static void sf_opaque_set_sim_state_c12_JointSpaceControl_CorrectFalseCombo
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c12_JointSpaceControl_CorrectFalseCombo(S, st);
}

static void sf_opaque_terminate_c12_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c12_JointSpaceControl_CorrectFalseCombo
      ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc12_JointSpaceControl_CorrectFalseCombo
    ((SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_JointSpaceControl_CorrectFalseCombo
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_JointSpaceControl_CorrectFalseCombo(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c12_JointSpaceControl_CorrectFalseCombo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_JointSpaceControl_CorrectFalseCombo(SimStruct *S)
{
  SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance;
  chartInstance = (SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct *)
    utMalloc(sizeof(SFc12_JointSpaceControl_CorrectFalseComboInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c12_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_JointSpaceControl_CorrectFalseCombo;
...
void c12_JointSpaceControl_CorrectFalseCombo_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_JointSpaceControl_CorrectFalseCombo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_JointSpaceControl_CorrectFalseCombo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_JointSpaceControl_CorrectFalseCombo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_JointSpaceControl_CorrectFalseCombo_method_dispatcher.\n"
