...
static void initialize_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void initialize_params_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void enable_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void disable_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void c30_update_debugger_state_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void set_sim_state_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance, const
   mxArray *c30_st);
static void finalize_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void sf_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void c30_chartstep_c30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void initSimStructsc30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void registerMessagesc30_JointSpaceControl_BestInertia
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
...
static void c30_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData);
static void c30_eml_scalar_eg(SFc30_JointSpaceControl_BestInertiaInstanceStruct *
  chartInstance);
...
static uint8_T c30_e_emlrt_marshallIn
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance, const
   mxArray *c30_b_is_active_c30_JointSpaceControl_BestInertia, const char_T
   *c30_identifier);
  ...
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c30_is_active_c30_JointSpaceControl_BestInertia = 0U;
}
  ...
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance)
{
  ...
  c30_hoistedGlobal =
    chartInstance->c30_is_active_c30_JointSpaceControl_BestInertia;
   ...
   mxArray *c30_st)
{
  ...
  chartInstance->c30_is_active_c30_JointSpaceControl_BestInertia =
    ...
    "is_active_c30_JointSpaceControl_BestInertia");
  sf_mex_destroy(&c30_u);
  c30_update_debugger_state_c30_JointSpaceControl_BestInertia(chartInstance);
  ...
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 23U, chartInstance->c30_sfEvent);
  ...
  chartInstance->c30_sfEvent = CALL_EVENT;
  c30_chartstep_c30_JointSpaceControl_BestInertia(chartInstance);
  ...
  (SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 23U, chartInstance->c30_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 23U, chartInstance->c30_sfEvent);
}
  ...
  *c30_inData)
{
  ...
  const mxArray *c30_y = NULL;
  SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc30_JointSpaceControl_BestInertiaInstanceStruct *)
    chartInstanceVoid;
   ...
   *c30_identifier)
{
  ...
  c30_y = c30_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c30_b_is_active_c30_JointSpaceControl_BestInertia), &c30_thisId);
  sf_mex_destroy(&c30_b_is_active_c30_JointSpaceControl_BestInertia);
  return c30_y;
}
...
void sf_c30_JointSpaceControl_BestInertia_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c30_JointSpaceControl_BestInertia_get_autoinheritance_info(void)
{
...
mxArray *sf_c30_JointSpaceControl_BestInertia_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c30_JointSpaceControl_BestInertia
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[8],T\"tau\",},{M[1],M[10],T\"tau_CDq\",},{M[1],M[11],T\"tau_G\",},{M[1],M[9],T\"tau_M\",},{M[8],M[0],T\"is_active_c30_JointSpaceControl_BestInertia\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c30_JointSpaceControl_BestInertia_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c30_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc30_JointSpaceControl_BestInertiaInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c30_JointSpaceControl_BestInertia
    ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
  initialize_c30_JointSpaceControl_BestInertia
    ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c30_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  enable_c30_JointSpaceControl_BestInertia
    ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c30_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  disable_c30_JointSpaceControl_BestInertia
    ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c30_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  sf_c30_JointSpaceControl_BestInertia
    ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c30_JointSpaceControl_BestInertia(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c30_JointSpaceControl_BestInertia
    ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c30_JointSpaceControl_BestInertia();/* state var info */
...
extern void sf_internal_set_sim_state_c30_JointSpaceControl_BestInertia
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c30_JointSpaceControl_BestInertia
    ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c30_JointSpaceControl_BestInertia
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c30_JointSpaceControl_BestInertia(S);
}

static void sf_opaque_set_sim_state_c30_JointSpaceControl_BestInertia(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c30_JointSpaceControl_BestInertia(S, st);
}

static void sf_opaque_terminate_c30_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c30_JointSpaceControl_BestInertia
      ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc30_JointSpaceControl_BestInertia
    ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c30_JointSpaceControl_BestInertia(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c30_JointSpaceControl_BestInertia
      ((SFc30_JointSpaceControl_BestInertiaInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c30_JointSpaceControl_BestInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c30_JointSpaceControl_BestInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c30_JointSpaceControl_BestInertia(SimStruct *S)
{
  SFc30_JointSpaceControl_BestInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc30_JointSpaceControl_BestInertiaInstanceStruct *)utMalloc
    (sizeof(SFc30_JointSpaceControl_BestInertiaInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.mdlStart = mdlStart_c30_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c30_JointSpaceControl_BestInertia;
...
void c30_JointSpaceControl_BestInertia_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c30_JointSpaceControl_BestInertia(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c30_JointSpaceControl_BestInertia(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c30_JointSpaceControl_BestInertia(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c30_JointSpaceControl_BestInertia_method_dispatcher.\n"
