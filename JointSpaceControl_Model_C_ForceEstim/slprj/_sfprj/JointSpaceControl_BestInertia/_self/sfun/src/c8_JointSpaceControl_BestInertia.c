...
static void initialize_c8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void initialize_params_c8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void enable_c8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void disable_c8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void set_sim_state_c8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance, const
   mxArray *c8_st);
static void finalize_c8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void sf_c8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void initSimStructsc8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void registerMessagesc8_JointSpaceControl_BestInertia
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_JointSpaceControl_BestInertiaInstanceStruct
...
static real_T c8_mpower(SFc8_JointSpaceControl_BestInertiaInstanceStruct
  *chartInstance, real_T c8_a);
static void c8_eml_scalar_eg(SFc8_JointSpaceControl_BestInertiaInstanceStruct
  *chartInstance);
...
static uint8_T c8_e_emlrt_marshallIn
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance, const
   mxArray *c8_b_is_active_c8_JointSpaceControl_BestInertia, const char_T
   *c8_identifier);
  ...
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_JointSpaceControl_BestInertia = 0U;
}
  ...
  (SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance)
{
  ...
  c8_hoistedGlobal =
    chartInstance->c8_is_active_c8_JointSpaceControl_BestInertia;
   ...
   mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_JointSpaceControl_BestInertia =
    ...
    "is_active_c8_JointSpaceControl_BestInertia");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_JointSpaceControl_BestInertia(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc8_JointSpaceControl_BestInertiaInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c8_JointSpaceControl_BestInertia_get_eml_resolved_functions_info(void)
{
   ...
   *c8_identifier)
{
  ...
  c8_y = c8_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_JointSpaceControl_BestInertia), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_JointSpaceControl_BestInertia);
  return c8_y;
}
...
void sf_c8_JointSpaceControl_BestInertia_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_JointSpaceControl_BestInertia_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_JointSpaceControl_BestInertia_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c8_JointSpaceControl_BestInertia
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"R\",},{M[8],M[0],T\"is_active_c8_JointSpaceControl_BestInertia\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_JointSpaceControl_BestInertia_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_JointSpaceControl_BestInertiaInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_JointSpaceControl_BestInertia
    ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
  initialize_c8_JointSpaceControl_BestInertia
    ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  enable_c8_JointSpaceControl_BestInertia
    ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  disable_c8_JointSpaceControl_BestInertia
    ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  sf_c8_JointSpaceControl_BestInertia
    ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_JointSpaceControl_BestInertia
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_JointSpaceControl_BestInertia
    ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_JointSpaceControl_BestInertia();/* state var info */
...
extern void sf_internal_set_sim_state_c8_JointSpaceControl_BestInertia(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_JointSpaceControl_BestInertia
    ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_JointSpaceControl_BestInertia
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c8_JointSpaceControl_BestInertia(S);
}

static void sf_opaque_set_sim_state_c8_JointSpaceControl_BestInertia(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_JointSpaceControl_BestInertia(S, st);
}

static void sf_opaque_terminate_c8_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c8_JointSpaceControl_BestInertia
      ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_JointSpaceControl_BestInertia
    ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_JointSpaceControl_BestInertia(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_JointSpaceControl_BestInertia
      ((SFc8_JointSpaceControl_BestInertiaInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_JointSpaceControl_BestInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_JointSpaceControl_BestInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_JointSpaceControl_BestInertia(SimStruct *S)
{
  SFc8_JointSpaceControl_BestInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc8_JointSpaceControl_BestInertiaInstanceStruct *)utMalloc
    (sizeof(SFc8_JointSpaceControl_BestInertiaInstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc8_JointSpaceControl_BestInertiaInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_JointSpaceControl_BestInertia;
...
void c8_JointSpaceControl_BestInertia_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_JointSpaceControl_BestInertia(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_JointSpaceControl_BestInertia(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_JointSpaceControl_BestInertia(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_JointSpaceControl_BestInertia_method_dispatcher.\n"
