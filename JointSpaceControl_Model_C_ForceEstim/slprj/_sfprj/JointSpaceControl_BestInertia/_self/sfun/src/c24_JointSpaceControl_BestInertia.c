...
static void initialize_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void initialize_params_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void enable_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void disable_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void c24_update_debugger_state_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void set_sim_state_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance, const
   mxArray *c24_st);
static void finalize_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void sf_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void c24_chartstep_c24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void initSimStructsc24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
static void registerMessagesc24_JointSpaceControl_BestInertia
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance);
...
static void c24_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData);
static void c24_eml_scalar_eg(SFc24_JointSpaceControl_BestInertiaInstanceStruct *
  chartInstance);
...
static uint8_T c24_e_emlrt_marshallIn
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance, const
   mxArray *c24_b_is_active_c24_JointSpaceControl_BestInertia, const char_T
   *c24_identifier);
  ...
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_is_active_c24_JointSpaceControl_BestInertia = 0U;
}
  ...
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance)
{
  ...
  c24_hoistedGlobal =
    chartInstance->c24_is_active_c24_JointSpaceControl_BestInertia;
   ...
   mxArray *c24_st)
{
  ...
  chartInstance->c24_is_active_c24_JointSpaceControl_BestInertia =
    ...
    "is_active_c24_JointSpaceControl_BestInertia");
  sf_mex_destroy(&c24_u);
  c24_update_debugger_state_c24_JointSpaceControl_BestInertia(chartInstance);
  ...
  (SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_sfEvent = CALL_EVENT;
  c24_chartstep_c24_JointSpaceControl_BestInertia(chartInstance);
  ...
  *c24_inData)
{
  ...
  const mxArray *c24_y = NULL;
  SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc24_JointSpaceControl_BestInertiaInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c24_JointSpaceControl_BestInertia_get_eml_resolved_functions_info(void)
{
   ...
   *c24_identifier)
{
  ...
  c24_y = c24_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c24_b_is_active_c24_JointSpaceControl_BestInertia), &c24_thisId);
  sf_mex_destroy(&c24_b_is_active_c24_JointSpaceControl_BestInertia);
  return c24_y;
}
...
void sf_c24_JointSpaceControl_BestInertia_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c24_JointSpaceControl_BestInertia_get_autoinheritance_info(void)
{
...
mxArray *sf_c24_JointSpaceControl_BestInertia_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c24_JointSpaceControl_BestInertia
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"tau\",},{M[8],M[0],T\"is_active_c24_JointSpaceControl_BestInertia\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_JointSpaceControl_BestInertia_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c24_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc24_JointSpaceControl_BestInertiaInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c24_JointSpaceControl_BestInertia
    ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
  initialize_c24_JointSpaceControl_BestInertia
    ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c24_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  enable_c24_JointSpaceControl_BestInertia
    ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c24_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  disable_c24_JointSpaceControl_BestInertia
    ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c24_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  sf_c24_JointSpaceControl_BestInertia
    ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c24_JointSpaceControl_BestInertia(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c24_JointSpaceControl_BestInertia
    ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c24_JointSpaceControl_BestInertia();/* state var info */
...
extern void sf_internal_set_sim_state_c24_JointSpaceControl_BestInertia
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c24_JointSpaceControl_BestInertia
    ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c24_JointSpaceControl_BestInertia
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c24_JointSpaceControl_BestInertia(S);
}

static void sf_opaque_set_sim_state_c24_JointSpaceControl_BestInertia(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c24_JointSpaceControl_BestInertia(S, st);
}

static void sf_opaque_terminate_c24_JointSpaceControl_BestInertia(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c24_JointSpaceControl_BestInertia
      ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc24_JointSpaceControl_BestInertia
    ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_JointSpaceControl_BestInertia(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c24_JointSpaceControl_BestInertia
      ((SFc24_JointSpaceControl_BestInertiaInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c24_JointSpaceControl_BestInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c24_JointSpaceControl_BestInertia(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_JointSpaceControl_BestInertia(SimStruct *S)
{
  SFc24_JointSpaceControl_BestInertiaInstanceStruct *chartInstance;
  chartInstance = (SFc24_JointSpaceControl_BestInertiaInstanceStruct *)utMalloc
    (sizeof(SFc24_JointSpaceControl_BestInertiaInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.mdlStart = mdlStart_c24_JointSpaceControl_BestInertia;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c24_JointSpaceControl_BestInertia;
...
void c24_JointSpaceControl_BestInertia_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_JointSpaceControl_BestInertia(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_JointSpaceControl_BestInertia(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_JointSpaceControl_BestInertia(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_JointSpaceControl_BestInertia_method_dispatcher.\n"
