...
static void initialize_c5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void initialize_params_c5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void enable_c5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void disable_c5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void set_sim_state_c5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance, const
   mxArray *c5_st);
static void finalize_c5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void sf_c5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void initSimStructsc5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void registerMessagesc5_JointSpaceControl_CorrectFalseCombo
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
...
static real_T c5_mpower(SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct
  *chartInstance, real_T c5_a);
static void c5_eml_scalar_eg
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void c5_eml_error(SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *
  chartInstance);
static real_T c5_atan2(SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct
...
static uint8_T c5_d_emlrt_marshallIn
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance, const
   mxArray *c5_b_is_active_c5_JointSpaceControl_CorrectFalseCombo, const char_T *
   c5_identifier);
  ...
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_JointSpaceControl_CorrectFalseCombo = 0U;
}
  ...
  (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance)
{
  ...
  c5_d_hoistedGlobal =
    chartInstance->c5_is_active_c5_JointSpaceControl_CorrectFalseCombo;
   ...
   mxArray *c5_st)
{
  ...
  *c5_theta = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
  ...
  chartInstance->c5_is_active_c5_JointSpaceControl_CorrectFalseCombo =
    ...
    "is_active_c5_JointSpaceControl_CorrectFalseCombo");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_JointSpaceControl_CorrectFalseCombo(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance;
  chartInstance = (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *)
    chartInstanceVoid;
   ...
   c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_JointSpaceControl_CorrectFalseCombo), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_JointSpaceControl_CorrectFalseCombo);
  return c5_y;
}
...
void sf_c5_JointSpaceControl_CorrectFalseCombo_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_JointSpaceControl_CorrectFalseCombo_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_JointSpaceControl_CorrectFalseCombo_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c5_JointSpaceControl_CorrectFalseCombo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[6],T\"phi\",},{M[1],M[10],T\"psi\",},{M[1],M[9],T\"theta\",},{M[8],M[0],T\"is_active_c5_JointSpaceControl_CorrectFalseCombo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_JointSpaceControl_CorrectFalseCombo_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c5_JointSpaceControl_CorrectFalseCombo
    ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
  initialize_c5_JointSpaceControl_CorrectFalseCombo
    ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  enable_c5_JointSpaceControl_CorrectFalseCombo
    ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  disable_c5_JointSpaceControl_CorrectFalseCombo
    ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  sf_c5_JointSpaceControl_CorrectFalseCombo
    ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_JointSpaceControl_CorrectFalseCombo(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_JointSpaceControl_CorrectFalseCombo
    ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c5_JointSpaceControl_CorrectFalseCombo();/* state var info */
...
extern void sf_internal_set_sim_state_c5_JointSpaceControl_CorrectFalseCombo
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_JointSpaceControl_CorrectFalseCombo
    ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_JointSpaceControl_CorrectFalseCombo(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_JointSpaceControl_CorrectFalseCombo(S);
}

static void sf_opaque_set_sim_state_c5_JointSpaceControl_CorrectFalseCombo
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_JointSpaceControl_CorrectFalseCombo(S, st);
}

static void sf_opaque_terminate_c5_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_JointSpaceControl_CorrectFalseCombo
      ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc5_JointSpaceControl_CorrectFalseCombo
    ((SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_JointSpaceControl_CorrectFalseCombo
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_JointSpaceControl_CorrectFalseCombo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c5_JointSpaceControl_CorrectFalseCombo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_JointSpaceControl_CorrectFalseCombo(SimStruct *S)
{
  SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance;
  chartInstance = (SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct *)
    utMalloc(sizeof(SFc5_JointSpaceControl_CorrectFalseComboInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_JointSpaceControl_CorrectFalseCombo;
...
void c5_JointSpaceControl_CorrectFalseCombo_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_JointSpaceControl_CorrectFalseCombo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_JointSpaceControl_CorrectFalseCombo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_JointSpaceControl_CorrectFalseCombo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_JointSpaceControl_CorrectFalseCombo_method_dispatcher.\n"
