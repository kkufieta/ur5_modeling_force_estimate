...
static void initialize_c13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void initialize_params_c13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void enable_c13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void disable_c13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_JointSpaceControl_CorrectFalseComb
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void set_sim_state_c13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance, const
   mxArray *c13_st);
static void finalize_c13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void sf_c13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void initSimStructsc13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
static void registerMessagesc13_JointSpaceControl_CorrectFalseCombo
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance);
...
static uint8_T c13_f_emlrt_marshallIn
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance, const
   mxArray *c13_b_is_active_c13_JointSpaceControl_CorrectFalseCombo, const
  ...
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_JointSpaceControl_CorrectFalseCombo = 0U;
}
  ...
  (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance)
{
  ...
  c13_b_hoistedGlobal =
    chartInstance->c13_is_active_c13_JointSpaceControl_CorrectFalseCombo;
   ...
   mxArray *c13_st)
{
  ...
  *c13_theta = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c13_is_active_c13_JointSpaceControl_CorrectFalseCombo =
    ...
    "is_active_c13_JointSpaceControl_CorrectFalseCombo");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_JointSpaceControl_CorrectFalseComb(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance;
  chartInstance = (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *)
    chartInstanceVoid;
   ...
   char_T *c13_identifier)
{
  ...
  c13_y = c13_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_JointSpaceControl_CorrectFalseCombo), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_JointSpaceControl_CorrectFalseCombo);
  return c13_y;
}
...
void sf_c13_JointSpaceControl_CorrectFalseCombo_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_JointSpaceControl_CorrectFalseCombo_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c13_JointSpaceControl_CorrectFalseCombo_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c13_JointSpaceControl_CorrectFalseCombo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"k\",},{M[1],M[6],T\"theta\",},{M[8],M[0],T\"is_active_c13_JointSpaceControl_CorrectFalseCombo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_JointSpaceControl_CorrectFalseCombo_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c13_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c13_JointSpaceControl_CorrectFalseCombo
    ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
  initialize_c13_JointSpaceControl_CorrectFalseCombo
    ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  enable_c13_JointSpaceControl_CorrectFalseCombo
    ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  disable_c13_JointSpaceControl_CorrectFalseCombo
    ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  sf_c13_JointSpaceControl_CorrectFalseCombo
    ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c13_JointSpaceControl_CorrectFalseCombo(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_JointSpaceControl_CorrectFalseCombo
    ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c13_JointSpaceControl_CorrectFalseCombo();/* state var info */
...
extern void sf_internal_set_sim_state_c13_JointSpaceControl_CorrectFalseCombo
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c13_JointSpaceControl_CorrectFalseCombo
    ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c13_JointSpaceControl_CorrectFalseCombo(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_JointSpaceControl_CorrectFalseCombo(S);
}

static void sf_opaque_set_sim_state_c13_JointSpaceControl_CorrectFalseCombo
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c13_JointSpaceControl_CorrectFalseCombo(S, st);
}

static void sf_opaque_terminate_c13_JointSpaceControl_CorrectFalseCombo(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c13_JointSpaceControl_CorrectFalseCombo
      ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc13_JointSpaceControl_CorrectFalseCombo
    ((SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_JointSpaceControl_CorrectFalseCombo
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_JointSpaceControl_CorrectFalseCombo(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c13_JointSpaceControl_CorrectFalseCombo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_JointSpaceControl_CorrectFalseCombo(SimStruct *S)
{
  SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *chartInstance;
  chartInstance = (SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct *)
    utMalloc(sizeof(SFc13_JointSpaceControl_CorrectFalseComboInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c13_JointSpaceControl_CorrectFalseCombo;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_JointSpaceControl_CorrectFalseCombo;
...
void c13_JointSpaceControl_CorrectFalseCombo_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_JointSpaceControl_CorrectFalseCombo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_JointSpaceControl_CorrectFalseCombo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_JointSpaceControl_CorrectFalseCombo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_JointSpaceControl_CorrectFalseCombo_method_dispatcher.\n"
