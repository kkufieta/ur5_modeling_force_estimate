...
static void initialize_c10_JointSpaceControl
  (SFc10_JointSpaceControlInstanceStruct *chartInstance);
static void initialize_params_c10_JointSpaceControl
  (SFc10_JointSpaceControlInstanceStruct *chartInstance);
static void enable_c10_JointSpaceControl(SFc10_JointSpaceControlInstanceStruct
  *chartInstance);
static void disable_c10_JointSpaceControl(SFc10_JointSpaceControlInstanceStruct *
  chartInstance);
static void c10_update_debugger_state_c10_JointSpaceControl
  (SFc10_JointSpaceControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_JointSpaceControl
  (SFc10_JointSpaceControlInstanceStruct *chartInstance);
static void set_sim_state_c10_JointSpaceControl
  (SFc10_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c10_st);
static void finalize_c10_JointSpaceControl(SFc10_JointSpaceControlInstanceStruct
  *chartInstance);
static void sf_c10_JointSpaceControl(SFc10_JointSpaceControlInstanceStruct
  *chartInstance);
static void c10_chartstep_c10_JointSpaceControl
  (SFc10_JointSpaceControlInstanceStruct *chartInstance);
static void initSimStructsc10_JointSpaceControl
  (SFc10_JointSpaceControlInstanceStruct *chartInstance);
static void registerMessagesc10_JointSpaceControl
  (SFc10_JointSpaceControlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_emlrt_marshallIn(SFc10_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c10_J2, const char_T *c10_identifier, real_T
  c10_y[18]);
static void c10_b_emlrt_marshallIn(SFc10_JointSpaceControlInstanceStruct
...
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_c_emlrt_marshallIn(SFc10_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c10_J, const char_T *c10_identifier, real_T
  c10_y[36]);
static void c10_d_emlrt_marshallIn(SFc10_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  real_T c10_y[36]);
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_e_emlrt_marshallIn(SFc10_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_e_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_f_emlrt_marshallIn(SFc10_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_g_emlrt_marshallIn(SFc10_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_JointSpaceControl, const
  char_T *c10_identifier);
static uint8_T c10_h_emlrt_marshallIn(SFc10_JointSpaceControlInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_JointSpaceControlInstanceStruct
  *chartInstance);
  ...
  (SFc10_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_JointSpaceControl = 0U;
}
  ...
  (SFc10_JointSpaceControlInstanceStruct *chartInstance)
{
  ...
  c10_hoistedGlobal = chartInstance->c10_is_active_c10_JointSpaceControl;
  ...
  (SFc10_JointSpaceControlInstanceStruct *chartInstance, const mxArray *c10_st)
{
  ...
  chartInstance->c10_is_active_c10_JointSpaceControl = c10_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 3)),
     "is_active_c10_JointSpaceControl");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_JointSpaceControl(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_sfEvent = CALL_EVENT;
  c10_chartstep_c10_JointSpaceControl(chartInstance);
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc10_JointSpaceControlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_JointSpaceControl_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c10_identifier)
{
  ...
  c10_y = c10_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_JointSpaceControl), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_JointSpaceControl);
  return c10_y;
}
...
void sf_c10_JointSpaceControl_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_JointSpaceControl_get_autoinheritance_info(void)
{
...
mxArray *sf_c10_JointSpaceControl_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c10_JointSpaceControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[6],T\"J\",},{M[1],M[7],T\"J1\",},{M[1],M[8],T\"J2\",},{M[8],M[0],T\"is_active_c10_JointSpaceControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_JointSpaceControl_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc10_JointSpaceControlInstanceStruct *chartInstance;
    chartInstance = (SFc10_JointSpaceControlInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c10_JointSpaceControl(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_JointSpaceControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_JointSpaceControl((SFc10_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
  initialize_c10_JointSpaceControl((SFc10_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_JointSpaceControl(void *chartInstanceVar)
{
  enable_c10_JointSpaceControl((SFc10_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c10_JointSpaceControl(void *chartInstanceVar)
{
  disable_c10_JointSpaceControl((SFc10_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_JointSpaceControl(void *chartInstanceVar)
{
  sf_c10_JointSpaceControl((SFc10_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_JointSpaceControl(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_JointSpaceControl
    ((SFc10_JointSpaceControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_JointSpaceControl();/* state var info */
...
extern void sf_internal_set_sim_state_c10_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c10_JointSpaceControl((SFc10_JointSpaceControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_JointSpaceControl(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_JointSpaceControl(S);
}

static void sf_opaque_set_sim_state_c10_JointSpaceControl(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c10_JointSpaceControl(S, st);
}

static void sf_opaque_terminate_c10_JointSpaceControl(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_JointSpaceControlInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c10_JointSpaceControl((SFc10_JointSpaceControlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_JointSpaceControl((SFc10_JointSpaceControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_JointSpaceControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c10_JointSpaceControl
      ((SFc10_JointSpaceControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c10_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c10_JointSpaceControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_JointSpaceControl(SimStruct *S)
{
  SFc10_JointSpaceControlInstanceStruct *chartInstance;
  chartInstance = (SFc10_JointSpaceControlInstanceStruct *)utMalloc(sizeof
    (SFc10_JointSpaceControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_JointSpaceControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_JointSpaceControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_JointSpaceControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_JointSpaceControl;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_JointSpaceControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c10_JointSpaceControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_JointSpaceControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_JointSpaceControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_JointSpaceControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_JointSpaceControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_JointSpaceControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_JointSpaceControl;
...
void c10_JointSpaceControl_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_JointSpaceControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_JointSpaceControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_JointSpaceControl_method_dispatcher.\n"
