...
static void initialize_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void initialize_params_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void enable_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void disable_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void set_sim_state_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance, const mxArray *
   c2_st);
static void finalize_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void sf_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void c2_chartstep_c2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void initSimStructsc2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void registerMessagesc2_JointSpaceControl_Manuf_MCP
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_JointSpaceControl_Manuf_MCPInstanceStruct
  *chartInstance, const mxArray *c2_r0_c6, const char_T *c2_identifier, real_T
  c2_y[3]);
static void c2_b_emlrt_marshallIn(SFc2_JointSpaceControl_Manuf_MCPInstanceStruct
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_JointSpaceControl_Manuf_MCPInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[9]);
...
static void c2_eml_scalar_eg(SFc2_JointSpaceControl_Manuf_MCPInstanceStruct
  *chartInstance);
...
static uint8_T c2_f_emlrt_marshallIn
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance, const mxArray *
   c2_b_is_active_c2_JointSpaceControl_Manuf_MCP, const char_T *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance, const mxArray *
   c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_JointSpaceControl_Manuf_MCPInstanceStruct
  *chartInstance);
  ...
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_JointSpaceControl_Manuf_MCP = 0U;
}
  ...
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_JointSpaceControl_Manuf_MCP;
   ...
   c2_st)
{
  ...
  chartInstance->c2_is_active_c2_JointSpaceControl_Manuf_MCP =
    c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 6)),
    "is_active_c2_JointSpaceControl_Manuf_MCP");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_JointSpaceControl_Manuf_MCP(chartInstance);
  ...
  (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_JointSpaceControl_Manuf_MCP(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_JointSpaceControl_Manuf_MCP_get_eml_resolved_functions_info
  (void)
{
   ...
   c2_b_is_active_c2_JointSpaceControl_Manuf_MCP, const char_T *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_JointSpaceControl_Manuf_MCP), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_JointSpaceControl_Manuf_MCP);
  return c2_y;
}
...
void sf_c2_JointSpaceControl_Manuf_MCP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_JointSpaceControl_Manuf_MCP_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_JointSpaceControl_Manuf_MCP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_JointSpaceControl_Manuf_MCP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[5],T\"r0_c1\",},{M[1],M[11],T\"r0_c2\",},{M[1],M[12],T\"r0_c3\",},{M[1],M[13],T\"r0_c4\",},{M[1],M[14],T\"r0_c5\",},{M[1],M[15],T\"r0_c6\",},{M[8],M[0],T\"is_active_c2_JointSpaceControl_Manuf_MCP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_JointSpaceControl_Manuf_MCP_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_JointSpaceControl_Manuf_MCP(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_JointSpaceControl_Manuf_MCP
    ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*) chartInstanceVar);
  initialize_c2_JointSpaceControl_Manuf_MCP
    ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_JointSpaceControl_Manuf_MCP(void
  *chartInstanceVar)
{
  enable_c2_JointSpaceControl_Manuf_MCP
    ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_JointSpaceControl_Manuf_MCP(void
  *chartInstanceVar)
{
  disable_c2_JointSpaceControl_Manuf_MCP
    ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_JointSpaceControl_Manuf_MCP(void
  *chartInstanceVar)
{
  sf_c2_JointSpaceControl_Manuf_MCP
    ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_JointSpaceControl_Manuf_MCP
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_JointSpaceControl_Manuf_MCP
    ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_JointSpaceControl_Manuf_MCP();/* state var info */
...
extern void sf_internal_set_sim_state_c2_JointSpaceControl_Manuf_MCP(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_JointSpaceControl_Manuf_MCP
    ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_JointSpaceControl_Manuf_MCP
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_JointSpaceControl_Manuf_MCP(S);
}

static void sf_opaque_set_sim_state_c2_JointSpaceControl_Manuf_MCP(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_JointSpaceControl_Manuf_MCP(S, st);
}

static void sf_opaque_terminate_c2_JointSpaceControl_Manuf_MCP(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_JointSpaceControl_Manuf_MCP
      ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_JointSpaceControl_Manuf_MCP
    ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_JointSpaceControl_Manuf_MCP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_JointSpaceControl_Manuf_MCP
      ((SFc2_JointSpaceControl_Manuf_MCPInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_JointSpaceControl_Manuf_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_JointSpaceControl_Manuf_MCP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_JointSpaceControl_Manuf_MCP(SimStruct *S)
{
  SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *chartInstance;
  chartInstance = (SFc2_JointSpaceControl_Manuf_MCPInstanceStruct *)utMalloc
    (sizeof(SFc2_JointSpaceControl_Manuf_MCPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_JointSpaceControl_Manuf_MCPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_JointSpaceControl_Manuf_MCP;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_JointSpaceControl_Manuf_MCP;
...
void c2_JointSpaceControl_Manuf_MCP_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_JointSpaceControl_Manuf_MCP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_JointSpaceControl_Manuf_MCP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_JointSpaceControl_Manuf_MCP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_JointSpaceControl_Manuf_MCP_method_dispatcher.\n"
